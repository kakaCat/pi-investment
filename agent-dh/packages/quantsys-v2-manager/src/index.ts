          ...
          properties: {
            ...
            _metadata: {
              ...
              properties: {
                ...
                warning: { type: ['string', 'null'], description: '警告信息（如配置错误），正常时为 null' },
              },
              additionalProperties: true,
            },
            error: { type: ['string', 'null'], description: '错误信息（如文件不存在）' },
            rate_limited: { type: ['boolean', 'null'], description: '是否被频率限制' },
          },
          additionalProperties: true,
        },
