...
Object.defineProperty(exports,Symbol.toStringTag,{value:`Module`});const e=`dsh-panel-activate`;function t(){let e=document.querySelector(`[data-pane="sidebar"], [class*="sidebarCol"], .dshDesktopUpstreamSidebar, .dshDesktopSidebarSurface`);if(e!==null)return e.querySelector(`[class*="logoRow"]`)?.parentElement??e.firstElementChild}function n(){return document.querySelector(`[data-pane="conversation"], [class*="centerCol"], .dshDesktopConversationSurface`)??void 0}function r(e){return String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]??e)}const i=e=>String(e).padStart(2,`0`);function a(e){if(!e)return null;let t=new Date(String(e));return Number.isNaN(t.getTime())?null:t}function o(e,t){if(!e)return`—`;let n=a(e);if(!n)return String(e).slice(0,16).replace(`T`,` `);let r=new Date,o=n.getFullYear()===r.getFullYear()&&n.getMonth()===r.getMonth()&&n.getDate()===r.getDate(),s=i(n.getHours())+`:`+i(n.getMinutes());return t?.omitDateIfToday&&o?s:(t?.withYear?n.getFullYear()+`-`+i(n.getMonth()+1)+`-`+i(n.getDate()):i(n.getMonth()+1)+`-`+i(n.getDate()))+` `+s}function s(e){let{prefix:n,icon:r,label:i,title:a,controller:o}=e,s=n.replace(/-([a-z])/g,(e,t)=>t.toUpperCase())+`Entry`,c=`[data-`+n+`-entry]`,l,u=()=>{let e=document.createElement(`button`);return e.type=`button`,e.className=n+`-entry`,e.dataset[s]=``,e.setAttribute(`aria-label`,a),e.title=a,e.innerHTML=r+`<span class="`+n+`-entry-label">`+i+`</span>`,e.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),o.toggle()}),e},d=()=>{let e=t();if(e===void 0)return!1;if(e.querySelector(c)!==null){let t=e.querySelector(c);return t!==void 0&&l===void 0&&(l=t),!0}let n=u(),r=e.querySelector(`[class*="logoRow"]`);return r!==null&&r.nextSibling!==null?e.insertBefore(n,r.nextSibling):e.prepend(n),l=n,!0};d();let f=new MutationObserver(()=>{(l===void 0||!document.contains(l)||l.parentElement===null)&&d()});f.observe(document.body,{childList:!0,subtree:!0});let p=window.setInterval(()=>{(l===void 0||!document.contains(l))&&d()},5e3),m=()=>{l?.setAttribute(`data-active`,o.isActive()?`true`:`false`)},h=window.setInterval(m,1e3);return m(),()=>{f.disconnect(),window.clearInterval(p),window.clearInterval(h),l?.remove(),l=void 0}}function c(t){let{panelName:r,activeAttr:i,otherActiveAttrs:a,pollMs:o=3e4,pauseOnHidden:s=!1,dispatchTarget:c=`window`,listenTarget:l=`window`,buildContainer:u,onMount:d,onPoll:f,onOpen:p,onClose:m}=t,h=!1,g,_,v,y=!1,b=()=>{if(g!==void 0||y)return;let e=n();if(e===void 0)return;let t=u();e.appendChild(t),g=t,v=d(t)??void 0},x=new MutationObserver(()=>{b()});x.observe(document.body,{childList:!0,subtree:!0}),b();let S=()=>{if(!(h||y)){h=!0,b();for(let e of a)document.documentElement.removeAttribute(e);document.documentElement.setAttribute(i,``),(c===`document`?document:window).dispatchEvent(new CustomEvent(e,{detail:r})),D(),p?.()}},C=()=>{!h||y||(h=!1,document.documentElement.removeAttribute(i),O(),m?.())},w=()=>{h?C():S()},T=()=>h,E=()=>{h&&f()},D=()=>{O(),_=window.setInterval(E,o)},O=()=>{_!==void 0&&(clearInterval(_),_=void 0)},k=()=>{document.hidden?O():h&&D()};s&&document.addEventListener(`visibilitychange`,k);let A=e=>{if(!h)return;let n=e.target;if(n===null||g!==void 0&&(g===n||g.contains(n)))return;let r=`[data-`+t.prefix+`-entry]`;n.closest(r)===null&&C()};document.addEventListener(`click`,A,!0);let j=e=>{let t=e.detail;t!==void 0&&t!==r&&h&&C()},M=l===`document`?document:window;return M.addEventListener(e,j),{open:S,close:C,toggle:w,isActive:T,dispose:()=>{y||(y=!0,O(),s&&document.removeEventListener(`visibilitychange`,k),document.removeEventListener(`click`,A,!0),M.removeEventListener(e,j),x.disconnect(),v?.(),g?.remove(),g=void 0)}}}const l=`[data-dsh-hld-view]`,u=[`data-dsh-atb-active`,`data-dsh-taskboard-active`,`data-dsh-ssh-active`,`data-dsh-exec-active`,`data-dsh-bbd-active`,`data-dsh-gen-active`],d=(e,t=2)=>(Number.isFinite(Number(e))?Number(e):0).toLocaleString(`zh-CN`,{minimumFractionDigits:t,maximumFractionDigits:t}),f=e=>{let t=Number(e)||0;return(t>0?`+`:``)+t.toLocaleString(`zh-CN`,{maximumFractionDigits:2})},p=e=>{let t=Number(e)||0;return(t>0?`+`:``)+t.toFixed(2)+`%`},m=e=>{let t=Number(e)||0;return t>1e-4?`up`:t<-1e-4?`down`:`flat`},h=e=>{let t=e.context;if(typeof t==`string`)return t;try{return JSON.stringify(t??``)}catch{return``}},g={600519:`贵州茅台`,"000858":`五粮液`,"000568":`泸州老窖`,600809:`山西汾酒`,600600:`青岛啤酒`,601288:`农业银行`,601398:`工商银行`,601939:`建设银行`,601988:`中国银行`,600036:`招商银行`,"000001":`平安银行`,6e5:`浦发银行`,601166:`兴业银行`,600016:`民生银行`,601328:`交通银行`,601318:`中国平安`,601601:`中国太保`,601628:`中国人寿`,600030:`中信证券`,601688:`华泰证券`,600900:`长江电力`,601857:`中国石油`,600028:`中国石化`,601088:`中国神华`,600019:`宝钢股份`,600585:`海螺水泥`,601668:`中国建筑`,601390:`中国中铁`,601766:`中国中车`,600104:`上汽集团`,601633:`长城汽车`,601238:`广汽集团`,"000333":`美的集团`,"000651":`格力电器`,600690:`海尔智家`,300750:`宁德时代`,"002594":`比亚迪`,601012:`隆基绿能`,600438:`通威股份`,"002460":`赣锋锂业`,600276:`恒瑞医药`,603259:`药明康德`,"000538":`云南白药`,300760:`迈瑞医疗`,"002415":`海康威视`,"000063":`中兴通讯`,"002230":`科大讯飞`,"002475":`立讯精密`,"002241":`歌尔股份`,688981:`中芯国际`,688111:`金山办公`,603986:`兆易创新`,"002049":`紫光国微`,300782:`卓胜微`,"002371":`北方华创`,688012:`中微公司`,"002463":`沪电股份`,"002815":`崇达技术`,"002050":`三花智控`,"000807":`云铝股份`,601138:`工业富联`,"002352":`顺丰控股`,601888:`中国中免`,"000725":`京东方A`,"002714":`牧原股份`,300498:`温氏股份`,601111:`中国国航`,600029:`南方航空`,600150:`中国船舶`,601989:`中国重工`,600893:`航发动力`,"002179":`中航光电`,300059:`东方财富`,600031:`三一重工`};function _(e){if(e.enabled===!1)return!1;if(e.expires_at){let t=new Date(e.expires_at).getTime();if(Number.isFinite(t)&&t<=Date.now())return!1}return!0}function v(e){let t={};for(let n of e){let e=h(n),r=/([\u4e00-\u9fa5]{2,10})\s*\(?0*(\d{6})\)?/g,i;for(;(i=r.exec(e))!==null;)t[i[2]]=i[1]}return t}function y(e,t){if(!e)return`—`;let n=String(e).replace(/\D/g,``).slice(-6);return g[n]??t[n]??n}const b=e=>String(e??``).replace(/\D/g,``);function x(e,t,n){let r=String(t??``).replace(/\D/g,``).slice(-6),i=String(e??``).trim();return i&&i!==r&&i!==String(t??``)?i:y(t,n)}function S(e){return/^(30|68)/.test(e)?-.1:-.08}function C(e,t=`current`,n=0){let i=e.summary??{},a=Array.isArray(e.accounts)?e.accounts:[],s=e.currentAccount??``,c=Array.isArray(e.positions)?e.positions:[],l=Array.isArray(e.watchRules)?e.watchRules:[],u=v(l),d=l.filter(e=>{let t=e.account;return t!=null&&t!==``&&t!==s?!1:_(e)}),f=a.length>1?`<div class="dsh-hld-acct">
  ...
  ${R(e,t)}
</div>`}function w(e,t,n){let r=m(e.dailyChange),i=m(e.totalPnl),a=Number(n.compliance?.cashRatio??(e.totalValue?e.cash/e.totalValue*100:0)),o=Number(n.compliance?.maxSingleStock??0),s=Number(n.compliance?.maxIndustry??0),c=Number(n.compliance?.maxDrawdown60d??0),l=(n.positions??[]).filter(e=>Number(e.profitLossPct)<=S(e.symbol)+1).length,u=(e,t,n=!1)=>`<span class="dsh-hld-chip ${e?`ok`:n?`warn`:`bad`}">${t} ${e?`✅`:`⚠️`}</span>`;return`<div class="dsh-hld-summary">
...
</div>`}function T(e,t,n){let r=new Set(n.map(e=>b(e.symbol))),i=e.map(e=>E(e,t,r)).join(``),a=e.length===0?`<tr><td colspan="7" class="dsh-hld-empty">当前账户暂无持仓 — 空仓等待信号是正确决策</td></tr>`:``;return`<div class="dsh-hld-card">
  ...
  <td>${g}</td>
</tr>`}function D(e){let t=Array.isArray(e.todayTrades)?e.todayTrades:[];if(t.length===0)return`<div class="dsh-hld-card">
      ...
      <div class="dsh-hld-emptybox">今日尚无自动交易 — 没有信号时空仓等待是正确决策</div>
        ...
        <td><span class="sec-name">${r(x(e.name,e.symbol,a))}</span> <span class="sec-code">${r(b(e.symbol))}</span></td>
  ...
  <div class="tblwrap"><table>
    ...
    ${s}
...
</div>`}function O(e,t,n){if(t<=9){let r=``;for(let i=0;i<t;i++)r+=n(i,String(i+1),i===e);return r}let r=[...new Set([0,t-1,e-1,e,e+1].filter(e=>e>=0&&e<t))].sort((e,t)=>e-t),i=``,a=-2;for(let t of r)t-a>1&&(i+=`<span class="gap">…</span>`),i+=n(t,String(t+1),t===e),a=t;return i}function k(e,t){let n=Array.isArray(e.tradeHistory)?e.tradeHistory:[],i=Math.max(1,Math.ceil(n.length/8)),a=Math.min(Math.max(0,Math.trunc(Number(t)||0)),i-1);if(n.length===0)return`<div class="dsh-hld-card" id="dsh-hld-hx">
      ...
      <div class="dsh-hld-emptybox">该账户暂无历史交易记录</div>
        ...
        <td><span class="sec-name">${r(x(e.name,e.symbol,c))}</span> <span class="sec-code">${r(b(e.symbol))}</span></td>
        ...
        <span class="dsh-hld-pg-nums">${O(a,i,(e,t,n)=>`<button type="button" class="dsh-hld-pgb${n?` act`:``}"${e===a?` aria-current="page"`:``} onclick="window.__dshHldHistoryPage && window.__dshHldHistoryPage(${e})">${t}</button>`)}</span>
  ...
  <div class="tblwrap"><table>
    ...
    <td class="dim">${l}</td>
    ${_}
  </tr>`}function L(e){let t=e.automation;if(!t||t.tasks.length===0)return``;let n=t.tasks,i=t.engine===!0,a=i?`引擎定时任务`:`执行例行任务`,o=t.executor?` · `+t.executor:``,s=t.note?`<div class="dsh-hld-auto-note">⚠️ ${r(t.note)}</div>`:``,c=(e.watchRules??[]).filter(e=>e.account===t.accountName&&_(e)).length,l=n.map(e=>i?I(e,!0,!1,t.executorCode):I(e,!1,!0,t.executorCode)).join(``),u=i?`<th class="r">今日 成/触</th><th>下次运行</th>`:`<th>处理</th>`;return`<div class="dsh-hld-card dsh-hld-auto">
...
</div>`}function R(e,t){let n=v(e.watchRules??[]);return A(e.watchRules??[],n,e.currentAccount??``,Array.isArray(e.accounts)?e.accounts:[],t)}function z(e){let t=e.params;if(e.type===`price_break`||String(e.operator||``).toLowerCase().includes(`price`)){if(t&&t.price!==void 0&&t.price!==null){let e=t.direction===`above`?`突破`:t.direction===`below`?`跌破`:`触碰`;return`<span class="cond-${t.direction===`above`?`up`:`down`}">${e}${d(t.price)}</span>`}if(e.threshold!==void 0&&e.threshold!==null)return`价格 `+e.threshold}return e.threshold!==void 0&&e.threshold!==null&&e.operator?String(e.operator||e.type).toUpperCase()+` `+e.threshold:String(e.type??e.operator??`条件`)}function B(e){return/止损|风控|破位|减仓保护/.test(e)?{cls:`warn`,text:`止损监控`}:/买入|低吸|介入|加仓|建仓|补仓/.test(e)?{cls:`buy`,text:`买入提醒`}:/卖出|止盈|减仓|高抛|目标价/.test(e)?{cls:`sell`,text:`卖出提醒`}:{cls:`on`,text:`常规监控`}}const V=[`accounts`,`currentAccount`,`summary`,`positions`,`automation`,`compliance`],H=[`watchRules`,`tradeHistory`,`todayTrades`];[...V,...H];function U(e){let t=Array.isArray(e?.parts)?e.parts:[];return H.every(e=>t.includes(e))}function W(e,t){return U(t)?e%4==0?`full`:`hot`:`full`}function G(e,t,n){return e===`mount`?null:W(e===`open`?1:t,n)}function K(e,t){if(t===void 0||t.length===0)return{...e};let n=t,r={};for(let t of n)t in e&&(r[t]=e[t]);return r}function q(e){return[`.`+e+`-solve { flex:none; border:1px solid #c6e2ff; background:#ecf5ff; color:#409eff; border-radius:5px; padding:2px 9px; font-size:11.5px; line-height:1.7; cursor:pointer; white-space:nowrap; vertical-align:middle; }`,`.`+e+`-solve:hover { background:#d9ecff; border-color:#79bbff; }`,`.`+e+`-solve:active { background:#c6e2ff; }`,`.`+e+`-solvepop { position:fixed; z-index:9999; min-width:232px; max-width:300px; background:var(--panel,#fff); border:1px solid var(--border,#e4e7ed); border-radius:8px; box-shadow:0 6px 22px rgba(0,0,0,.16); padding:6px; font-size:12.5px; color:var(--body,#606266); }`,`.`+e+`-solvepop-head { padding:4px 8px 7px; color:var(--text,#303133); font-weight:600; font-size:12px; border-bottom:1px solid var(--line,#ebeef5); margin-bottom:4px; }`,`.`+e+`-solvepop-list { display:flex; flex-direction:column; max-height:264px; overflow-y:auto; }`,`.`+e+`-solvepop-item { border:none; background:transparent; text-align:left; padding:5px 8px; border-radius:5px; cursor:pointer; color:var(--body,#606266); font:inherit; font-size:12.5px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }`,`.`+e+`-solvepop-item:hover { background:var(--hover,rgba(128,128,128,.12)); }`,`.`+e+`-solvepop-item.cur { color:#409eff; font-weight:600; }`,`.`+e+`-solvepop-item.off { color:var(--dim,#909399); font-style:italic; }`,`.`+e+`-solvepop-cancel { width:100%; margin-top:4px; border:none; background:transparent; color:var(--dim,#909399); font:inherit; font-size:12px; padding:4px; cursor:pointer; border-top:1px solid var(--line,#ebeef5); }`,`.`+e+`-solvepop-cancel:hover { color:var(--text,#303133); }`,`.`+e+`-toast { position:fixed; left:50%; bottom:54px; transform:translateX(-50%); z-index:10000; max-width:70vw; background:#303133; color:#fff; border-radius:7px; padding:7px 15px; font-size:12.5px; line-height:1.6; box-shadow:0 4px 16px rgba(0,0,0,.22); transition:opacity .35s, transform .35s; }`,`.`+e+`-toast.ok { background:#529b2e; }`,`.`+e+`-toast.err { background:#e64545; }`,`.`+e+`-toast.out { opacity:0; transform:translateX(-50%) translateY(8px); }`].join(`
`)}function J(e){let t=`dsh-solve-styles-`+e,n=document.getElementById(t);if(n!==null&&n.tagName===`STYLE`)return()=>n.remove();let r=document.createElement(`style`);return r.id=t,r.textContent=q(e),(document.head??document.documentElement).appendChild(r),()=>{document.getElementById(t)?.remove()}}function Y(e){let t=e.prefix,n,r,i=()=>{r?.(),r=void 0,n!==void 0&&(n.remove(),n=void 0)},a=(e,n)=>{let r=document.createElement(`div`);r.className=t+`-toast `+(n?`ok`:`err`),r.textContent=e,document.body.appendChild(r),window.setTimeout(()=>{r.classList.add(`out`),window.setTimeout(()=>r.remove(),350)},4200)},o=async(t,n,r)=>{let i=e.current();console.log(`[solve-kit] postSolve`,{endpoint:e.endpoint,kind:t,toSession:r,from:i});try{let o=await fetch(e.endpoint,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({kind:t,task:t===`task`?n:void 0,err:t===`error`?n:void 0,from_session:i||void 0,to_session:r})}),s=await o.json().catch(()=>null);if(console.log(`[solve-kit] response`,s),s===null||s.success!==!0){a(`投递失败：`+String(s?.error??`HTTP `+o.status),!1);return}let c=s.data;if(a(c?.delivered===!0?`✓ `+String(c?.note??`已投递`):`⚠ `+String(c?.error??s.error??`投递失败`),c?.delivered===!0),c?.delivered===!0&&c.target?.sessionId)try{let e=window,t=e.__dshHldSessions??e.__dshExecSessions??e.__dshBbdSessions??e.__dshPmSessions??e.__dshHldCtx?.sessions??e.__dshExecCtx?.sessions??e.__dshBbdCtx?.sessions??e.__dshPmCtx?.sessions;t&&typeof t.open==`function`?(console.log(`[solve-kit] auto-opening target session:`,c.target.sessionId),t.open(c.target.sessionId)):console.warn(`[solve-kit] sessions service not available for auto-open`)}catch(e){console.warn(`[solve-kit] failed to auto-open session:`,e)}}catch(e){a(`请求异常：`+String(e instanceof Error?e.message:e),!1)}},s=e=>{let t=e.lastIndexOf(`session-`);return t>=0&&e.length>=t+16?`w-`+e.slice(t+8,t+16):e};return{toast:a,openPicker:(c,l,u)=>{console.log(`[solve-kit] openPicker`,{kind:l,identity:u});let d=e.resolveSnapshot(l,u);if(console.log(`[solve-kit] resolveSnapshot`,d),d===null){a(`⚠ 数据已刷新，请重试`,!1);return}i();let f=c.getBoundingClientRect();(async()=>{let t=null;try{let n=await e.online?.();Array.isArray(n)&&(t=new Set(n.map(String)))}catch{}let n=e.candidates();if(n.length===0&&t!==null&&t.size>0){let r=String(e.current()??``);n=[...t].map(e=>({sid:String(e),label:s(String(e)),current:String(e)===r})),console.warn(`[solve-kit] 会话候选为空，回退在线窗口清单合成候选`,n.length)}if(n.length===0){o(d.kind,d.snap);return}p(n,t,f)})();let p=(a,s,c)=>{let l=document.createElement(`div`);l.className=t+`-solvepop`;let u=document.createElement(`div`);u.className=t+`-solvepop-head`,u.textContent=`投递给窗口排查处置`+(s===null?``:`（● 当前 / ○ 在线 / ○离线）`),l.appendChild(u);let f=document.createElement(`div`);f.className=t+`-solvepop-list`;let p=(e,n)=>{let r=document.createElement(`button`);return r.type=`button`,r.className=t+`-solvepop-item`+(e.current?` cur`:``)+(n?``:` off`),r.textContent=(e.current?`● `:`○ `)+e.label+(n?``:`（离线）`),r.addEventListener(`click`,()=>{if(!n){if(!window.confirm(`窗口「`+e.label+`」不在线（agent 未加载），直接投递必失败。

确定改投到当前在线窗口处理吗？
（或先到该窗口发一条消息激活后再重试）`))return;i(),o(d.kind,d.snap);return}i(),o(d.kind,d.snap,e.sid)}),r},m=a.filter(e=>s===null||e.current||s.has(e.sid)),h=a.filter(e=>!(s===null||e.current||s.has(e.sid)));m.sort((e,t)=>Number(t.current)-Number(e.current));for(let e of m)f.appendChild(p(e,!0));if(h.length>0){let e=document.createElement(`div`);e.style.display=`none`;for(let t of h)e.appendChild(p(t,!1));let n=document.createElement(`button`);n.type=`button`,n.className=t+`-solvepop-cancel`;let r=e=>{n.textContent=(e?`▾ 收起离线窗口`:`▸ 显示离线/已归档窗口`)+`（`+h.length+`）`};r(!1),n.addEventListener(`click`,()=>{let t=e.style.display!==`none`;e.style.display=t?`none`:``,r(!t)}),f.appendChild(n),f.appendChild(e)}l.appendChild(f);let g=document.createElement(`button`);g.type=`button`,g.className=t+`-solvepop-cancel`,g.textContent=`取消`,g.addEventListener(`click`,i),l.appendChild(g);let _;try{_=typeof e.host==`function`?e.host():e.host}catch{_=void 0}(_??document.body).appendChild(l),n=l;let v=40+(m.length+ +(h.length>0))*30+32,y=c.bottom+6;y+v>window.innerHeight&&(y=Math.max(6,c.top-v-6)),l.style.position=`fixed`,l.style.left=Math.max(6,Math.min(c.left,Math.max(6,window.innerWidth-280)))+`px`,l.style.top=y+`px`;let b=e=>{let t=e.target;t!==null&&l.contains(t)||(document.removeEventListener(`click`,b,!0),r=void 0,i())};document.addEventListener(`click`,b,!0),r=()=>document.removeEventListener(`click`,b,!0)}},close:i}}function X(){let e=`agent_brain`,t=`current`,n=0,r,i,a=0,o=0,s=async(t,n=`full`)=>{let i=++o,a=t;try{let s=`/dashboard/api/holdings?account=`+encodeURIComponent(t)+(n===`hot`?`&parts=hot`:``),l=await(await fetch(s)).json();if(!l.success)throw Error(l.error||`Unknown error`);let u=l.data;if(i!==o){console.log(`[dashboard-holdings] 丢弃过期响应（有更新的请求在后）: `+a);return}if(a!==e){console.log(`[dashboard-holdings] 丢弃跨账户响应: `+a+`（当前 `+e+`）`);return}let d=r===void 0?{...u,currentAccount:a,parts:u.parts}:{...r,...K(u,u.parts),currentAccount:a,parts:u.parts};c(d)}catch(e){console.error(`[dashboard-holdings] fetch failed:`,e),u(String(e))}},c=e=>{r=e;let a=document.querySelector(l);if(!a){console.error(`[dashboard-holdings] 渲染失败：找不到看板容器 [data-dsh-hld-view]（容器由 page-kit createBoardShell 挂到中心栏；找不到时数据会全部丢失且原本不报错）`),i===void 0&&(i=window.setTimeout(()=>{i=void 0;let r=document.querySelector(l);r?(console.log(`[dashboard-holdings] 重试成功：容器已就绪，补渲染`),r.innerHTML=C(e,t,n)):console.error(`[dashboard-holdings] 重试仍失败：容器始终未出现 —— 看板将无法显示任何数据`)},400));return}a.innerHTML=C(e,t,n),console.log(`[dashboard-holdings] 已渲染：账户=`+(e.currentAccount??`?`)+`，账户数=`+(e.accounts?.length??0)+`，持仓行=`+(e.positions?.length??0))},u=e=>{let t=document.querySelector(l);t&&(t.innerHTML=`<div class="dsh-hld-board"><div class="dsh-hld-wrap"><div class="dsh-hld-head"><h1 class="dsh-hld-title">持仓看板</h1></div><div class="dsh-hld-banner show">数据加载失败: `+e+`</div></div></div>`)},d=e=>{let n=String(e||`current`);if(n===t||(t=n,!r))return;let i=document.getElementById(`dsh-hld-watch`);if(i===null){c(r);return}let a=document.createElement(`template`);a.innerHTML=R(r,t);let o=a.content.firstElementChild;if(o===null){c(r);return}i.replaceWith(o)},f=e=>{let t=r?.tradeHistory?.length??0,i=Math.max(1,Math.ceil(t/8)),a=Math.max(0,Math.min(Math.trunc(Number(e)||0),i-1));if(a===n||(n=a,!r))return;let o=document.getElementById(`dsh-hld-hx`);if(o===null){c(r);return}let s=document.createElement(`template`);s.innerHTML=k(r,n);let l=s.content.firstElementChild;if(l===null){c(r);return}o.replaceWith(l)},p=Y({endpoint:`/dashboard/api/holdings/solve`,prefix:`dsh-hld`,candidates:()=>[],current:()=>{let e=window;try{return String((e.__dshHldSessions??e.__dshHldCtx?.sessions)?.list?.getSnapshot?.().current??``)}catch{return``}},resolveSnapshot:(e,t)=>{if(e!==`task`)return null;let n=r?.automation;if(!n||n.engine===!0)return null;let i=(n.tasks??[]).find(e=>String(e.name)===String(t.name??``));if(!i)return null;let a=String(r?.summary?.lastUpdated??``);return{kind:`task`,snap:{name:i.name,src:String(i.command||`Agent OS 调度任务`),scheduleExpr:i.scheduleExpr,nextRunAt:i.nextRunAt,lastRun:{status:i.lastStatus,triggeredAt:i.lastAt,finishedAt:i.lastAt,err:i.lastError},todayTriggered:i.todayTriggered,todaySuccess:i.todaySuccess,fetchedAt:a,error:i.lastError}}}});return{openBoard:()=>void 0,closeBoard:()=>void 0,toggleBoard:()=>void 0,getSnapshot:()=>({boardOpen:!1}),refresh:()=>{a+=1;let t=G(`poll`,a,r);t!==null&&(console.log(`[dashboard-holdings] refresh (`+t+`)`),s(e,t))},refreshOnOpen:()=>{a=0;let t=G(`open`,1,r);t!==null&&(console.log(`[dashboard-holdings] open refresh (`+t+`)`),s(e,t))},switchAccount:r=>{console.log(`[dashboard-holdings] switching account to`,r),e=r,t=`current`,n=0,a=0,s(r)},watchSwitch:d,historyPageSwitch:f,solveTask:e=>{if(!e)return;let t=String(e.dataset?.solveTask??``);t&&p.openPicker(e,`task`,{name:t})}}}function Z(e){window.__dshHldRefresh=()=>e.refresh(),window.__dshHldSwitchAccount=t=>e.switchAccount(t),window.__dshHldWatchTab=t=>e.watchSwitch(String(t)),window.__dshHldHistoryPage=t=>e.historyPageSwitch(Number(t)),window.__dshHldSolveTask=t=>e.solveTask(t);let t=c({prefix:`dsh-hld`,panelName:`dashboard-holdings`,activeAttr:`data-dsh-hld-active`,otherActiveAttrs:u,pollMs:15e3,pauseOnHidden:!0,buildContainer:()=>{let e=document.createElement(`div`);return e.setAttribute(`data-dsh-hld-view`,``),e.className=`dsh-hld-view`,e},onMount:()=>void 0,onOpen:()=>e.refreshOnOpen(),onPoll:()=>e.refresh()}),n=e;return n.openBoard=t.open,n.closeBoard=t.close,n.toggleBoard=t.toggle,n.getSnapshot=()=>({boardOpen:t.isActive()}),()=>{t.dispose(),delete window.__dshHldRefresh,delete window.__dshHldSwitchAccount,delete window.__dshHldWatchTab,delete window.__dshHldHistoryPage,delete window.__dshHldSolveTask,console.log(`[dashboard-holdings] board unmounted`)}}function Q(e){return s({prefix:`dsh-hld`,icon:`<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="8" cy="8" r="6"/><path d="M8 2 V8 L12 11"/><path d="M8 8 L4 5"/></svg>`,label:`账户持仓`,title:`账户持仓看板`,controller:e})}function $(){let e=`dsh-hld-styles`;if(document.getElementById(e)!==null)return;let t=document.createElement(`style`);t.id=e,t.textContent=`
.dsh-hld-entry {
...
`,(document.head??document.documentElement).appendChild(t)}const ee=[`slots`,`sessions`,`workspaces`];function te(e){try{try{window.__dshHldCtx=e,window.__dshHldSessions=e.sessions,window.__dshHldWorkspaces=e.workspaces}catch{}$(),J(`dsh-hld`),window.__dshHldClient?.dispose();let t=X(),n=Z(t),r=Q({isActive:()=>t.getSnapshot().boardOpen,toggle:()=>t.toggleBoard()});window.__dshHldClient={dispose:()=>{n(),r(),t.closeBoard()}}}catch(e){console.error(`[dashboard-holdings] client half failed to start:`,e)}}exports.apply=te,exports.inject=ee,exports.name=`@pi-investment/dashboard-holdings/client`;
