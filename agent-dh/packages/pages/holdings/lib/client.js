window.__ModuleLoader__.load({
		...
		`,(document.head??document.documentElement).appendChild(t)}const J=[`slots`,`sessions`,`workspaces`];function Y(e){try{try{window.__dshHldCtx=e,window.__dshHldSessions=e.sessions,window.__dshHldWorkspaces=e.workspaces}catch{}q(),H(`dsh-hld`),window.__dshHldClient?.dispose();let t=W(),n=G(t),r=K({isActive:()=>t.getSnapshot().boardOpen,toggle:()=>t.toggleBoard()});window.__dshHldClient={dispose:()=>{n(),r(),t.closeBoard()}}}catch(e){console.error(`[dashboard-holdings] client half failed to start:`,e)}}exports.apply=Y,exports.inject=J,exports.name=`@pi-investment/dashboard-holdings/client`;
