window.__ModuleLoader__.load({
		...
		`,(document.head??document.documentElement).appendChild(t)}const Z=[`slots`,`sessions`,`workspaces`];function Q(e){try{try{window.__dshHldCtx=e,window.__dshHldSessions=e.sessions,window.__dshHldWorkspaces=e.workspaces}catch{}X(),G(`dsh-hld`),window.__dshHldClient?.dispose();let t=q(),n=J(t),r=Y({isActive:()=>t.getSnapshot().boardOpen,toggle:()=>t.toggleBoard()});window.__dshHldClient={dispose:()=>{n(),r(),t.closeBoard()}}}catch(e){console.error(`[dashboard-holdings] client half failed to start:`,e)}}exports.apply=Q,exports.inject=Z,exports.name=`@pi-investment/dashboard-holdings/client`;
