Object.defineProperty(exports,Symbol.toStringTag,{value:`Module`});let e=require("react");const t=`dsh-panel-activate`;function n(){return document.querySelector(`[data-pane="conversation"], [class*="centerCol"], .dshDesktopConversationSurface`)??void 0}function r(e){return String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]??e)}function i(e){let{panelName:r,activeAttr:i,otherActiveAttrs:a,pollMs:o=3e4,pauseOnHidden:s=!1,dispatchTarget:c=`window`,listenTarget:l=`window`,buildContainer:u,onMount:d,onPoll:f,onOpen:p,onClose:m}=e,h=!1,g,_,v,y=!1,b=()=>{if(g!==void 0||y)return;let e=n();if(e===void 0)return;let t=u();e.appendChild(t),g=t,v=d(t)??void 0},x=new MutationObserver(()=>{b()});x.observe(document.body,{childList:!0,subtree:!0}),b();let S=()=>{if(!(h||y)){h=!0,b();for(let e of a)document.documentElement.removeAttribute(e);document.documentElement.setAttribute(i,``),(c===`document`?document:window).dispatchEvent(new CustomEvent(t,{detail:r})),D(),p?.()}},C=()=>{!h||y||(h=!1,document.documentElement.removeAttribute(i),O(),m?.())},w=()=>{h?C():S()},T=()=>h,E=()=>{h&&f()},D=()=>{O(),_=window.setInterval(E,o)},O=()=>{_!==void 0&&(clearInterval(_),_=void 0)},k=()=>{document.hidden?O():h&&D()};s&&document.addEventListener(`visibilitychange`,k);let A=t=>{if(!h)return;let n=t.target;if(n===null||g!==void 0&&(g===n||g.contains(n)))return;let r=`[data-`+e.prefix+`-entry]`;n.closest(r)===null&&C()};document.addEventListener(`click`,A,!0);let j=e=>{let t=e.detail;t!==void 0&&t!==r&&h&&C()},M=l===`document`?document:window;return M.addEventListener(t,j),{open:S,close:C,toggle:w,isActive:T,dispose:()=>{y||(y=!0,O(),s&&document.removeEventListener(`visibilitychange`,k),document.removeEventListener(`click`,A,!0),M.removeEventListener(t,j),x.disconnect(),v?.(),g?.remove(),g=void 0)}}}const a=`dsh-pmboard`,o=`项目看板`,s=[`data-dsh-atb-active`,`data-dsh-taskboard-active`,`data-dsh-ssh-active`,`data-dsh-hld-active`,`data-dsh-bbd-active`,`data-dsh-gen-active`,`data-dsh-exec-active`],c={draft:`立项`,reviewing:`评审`,decomposing:`拆分`,implementing:`实施`,accepting:`验收`,done:`完成`,archived:`归档`,canceled:`取消`},l={todo:`待办`,in_progress:`进行中`,integrating:`联调`,testing:`测试`,in_review:`验收`,done:`完成`,canceled:`取消`},u={doc:`文档`,ui:`UI`,analysis:`分析`,implement:`实施`,test:`测试`,review:`评审`,merge:`合并`},d={feature:`功能`,bug:`缺陷`,doc:`文档`,refactor:`重构`,spike:`调研`,chore:`杂项`},f=[`draft`,`reviewing`,`decomposing`,`implementing`,`accepting`,`done`];function p(e){let t=e.startsWith(`session-`)?e.slice(8):e;return`w-${(t.split(`-`)[0]??t).slice(0,8)}`}const m=e=>{let t=new Date(e),n=e=>String(e).padStart(2,`0`);return`${n(t.getMonth()+1)}-${n(t.getDate())} ${n(t.getHours())}:${n(t.getMinutes())}`};function h(e,t){return t===0?`0/0`:`${e}/${t}`}function g(e){return e.requirements.filter(e=>e.status!==`archived`&&e.status!==`canceled`).map(t=>{let n=e.tasks.filter(e=>e.requirementId===t.id);return{req:t,tasks:n,doneCount:n.filter(e=>e.status===`done`).length,totalCount:n.length,readyIds:e.ready[t.id]??[],blocked:t.blocked||n.some(e=>e.blocked)}})}function _(e,t=Date.now()){let n=g(e),i=f.map(e=>{let r=n.filter(t=>t.req.status===e),i=r.map(e=>v(e,t)).join(``);return`
    ...
    <div class="dsh-pm-board">
      ...
      ${o}
    </div>`}function v(e,t){let{req:n,tasks:i,doneCount:a,totalCount:o,readyIds:s,blocked:c}=e,l=o>0?Math.round(a/o*100):0,u=n.category?`<span class="dsh-pm-cat" data-cat="${n.category}">${d[n.category]??n.category}</span>`:``,f=ie(n),p=c?`<span class="dsh-pm-flag blocked">阻塞</span>`:``,m=n.paused?`<span class="dsh-pm-flag paused">暂停</span>`:``,g=s.length>0?`<span class="dsh-pm-flag ready">${s.length} ready</span>`:``,_=re(n,t),v=b(n)+x(i),S=y(n);return`
    ...
    </div>`}function k(){return`<div class="dsh-pm-board"><div class="dsh-pm-empty">暂无数据 — 点击「+ 需求」创建第一个需求</div></div>`}function A(e){return`<div class="dsh-pm-board"><div class="dsh-pm-error">加载失败：${r(e)}</div></div>`}function j(e){let t=Math.floor(Math.max(0,e)/6e4);if(t<60)return t+` 分`;let n=Math.floor(t/60);return n<24?n+` 小时 `+t%60+` 分`:Math.floor(n/24)+` 天 `+n%24+` 小时`}function M(e){return e===`done`||e===`archived`||e===`canceled`}function N(e,t){let n=e.statusHistory;if(n!==void 0&&n.length>0)return n;let r=[{status:t,at:e.createdAt,by:{kind:`human`},reason:`创建`,inferred:!0}];return e.status!==void 0&&e.status!==t&&e.updatedAt!==void 0&&r.push({status:e.status,at:Math.max(e.updatedAt,e.createdAt),by:e.updatedBy??{kind:`human`},reason:`按 updatedAt 回填（当时无事件留痕）`,inferred:!0}),r}function P(e,t,n,i,a){let o=N(e,i),s=new Map;o.forEach((e,t)=>{s.has(e.status)||s.set(e.status,t)});let c=o.map((e,t)=>({e,i:t})).filter(e=>!t.includes(e.e.status)).map(e=>e.e.status),l=(e,t)=>{if(t===void 0)return`<div class="dsh-pm-tl-row pending" data-status="`+e+`"><span class="dsh-pm-tl-label">`+(n[e]??e)+`</span><span class="dsh-pm-tl-time">—</span><span class="dsh-pm-tl-dur"></span></div>`;let i=o[t],s=o[t+1],c=t===o.length-1,l=(s?.at??a)-i.at,u=c?M(i.status)?``:`已停留 `+j(l):`停留 `+j(l),d=i.by.kind+(i.by.sessionId===void 0?``:` `+p(i.by.sessionId));return`<div class="dsh-pm-tl-row`+(c?` current`:``)+`" data-status="`+r(i.status)+`"><span class="dsh-pm-tl-label">`+(n[e]??e)+`</span><span class="dsh-pm-tl-time">`+r(m(i.at))+`</span><span class="dsh-pm-tl-dur">`+r(u)+`</span><span class="dsh-pm-tl-by">`+r(d)+`</span>`+(i.inferred===!0?`<span class="dsh-pm-tl-inferred" title="历史回填：老记录无事件留痕，由创建时间与评论反推">回填</span>`:``)+`</div>`},u=t.map(e=>l(e,s.get(e))).join(``)+c.map(e=>l(e,s.get(e))).join(``),d=o[0].at,f=o[o.length-1],h=(M(f.status)?f.at:a)-d;return`<div class="dsh-pm-timeline">`+u+`<div class="dsh-pm-tl-total">创建 `+r(m(d))+(M(f.status)?` · 总耗时 `:` · 至今 `)+r(j(h))+`</div></div>`}function F(e,t){return P(e,f.concat([`archived`]),c,`draft`,t)}function ee(e,t){return P(e,L,l,`todo`,t)}function I(e){let t=N(e,`draft`),n=new Map;for(let e of t)n.has(e.status)||n.set(e.status,e);let i=[...n.values()].map(e=>`<span class="dsh-pm-strip-item" data-status="`+r(e.status)+`">`+(c[e.status]??e.status)+` <b>`+r(m(e.at))+`</b></span>`);return i.length===0?``:`<div class="dsh-pm-strip">`+i.join(`<span class="dsh-pm-strip-arrow">→</span>`)+`</div>`}const L=[`todo`,`in_progress`,`integrating`,`testing`,`in_review`,`done`],R=[`draft`,`reviewing`,`decomposing`,`implementing`,`accepting`,`done`,`archived`];function z(e,t){let n=N(e,`todo`),r=M(e.status);return n.map((i,a)=>{let o=n[a+1]?.at??(r?Math.max(e.updatedAt,i.at):t);return{status:i.status,from:i.at,to:o}})}function B(e,t){return e.length>t?e.slice(0,t)+`…`:e}function V(e,t,n){if(t.length===0)return`<div class="dsh-pm-empty">尚未拆分任务</div>`;let i=[...t].sort((e,t)=>e.createdAt-t.createdAt),a=[n];for(let e of i)for(let t of N(e,`todo`))a.push(t.at);for(let t of N(e,`draft`))a.push(t.at);let o=Math.min(...a),s=Math.max(...a),u=Math.max(s-o,36e5),d=e=>190+(e-o)/u*620,f=34+i.length*22+10,p=[];p.push(`<svg class="dsh-pm-gantt" viewBox="0 0 822 `+f+`" width="100%" height="`+f+`" preserveAspectRatio="xMinYMin meet" role="img" aria-label="任务甘特图">`);for(let e=0;e<=4;e++){let t=o+u*e/4,n=d(t).toFixed(1);p.push(`<line class="dsh-pm-gantt-grid" x1="`+n+`" y1="26" x2="`+n+`" y2="`+(f-10)+`" />`),p.push(`<text class="dsh-pm-gantt-axis" x="`+n+`" y="20" text-anchor="middle">`+r(m(t))+`</text>`)}for(let t of N(e,`draft`)){if(!R.includes(t.status))continue;let n=d(t.at).toFixed(1);p.push(`<line class="dsh-pm-gantt-mile" data-status="`+r(t.status)+`" x1="`+n+`" y1="28" x2="`+n+`" y2="`+(f-10)+`">`),p.push(`<title>`+r(e.id+` `+(c[t.status]??t.status)+` `+m(t.at))+`</title></line>`)}if(i.forEach((e,t)=>{let i=34+t*22;p.push(`<text class="dsh-pm-gantt-rowlabel" x="6" y="`+(i+13)+`">`+r(B(e.id+` `+e.title,24))+`</text>`),p.push(`<rect class="dsh-pm-gantt-track" x="190" y="`+(i+4)+`" width="620" height="13" rx="3" />`);for(let t of z(e,n)){let n=d(t.from),a=Math.max(2,d(t.to)-n);p.push(`<rect class="dsh-pm-gantt-bar" data-status="`+r(t.status)+`" x="`+n.toFixed(1)+`" y="`+(i+4)+`" width="`+a.toFixed(1)+`" height="13" rx="3">`),p.push(`<title>`+r(e.id+` `+e.title+`｜`+(l[t.status]??t.status)+` `+m(t.from)+` → `+m(t.to)+`（`+j(t.to-t.from)+`）`)+`</title></rect>`)}}),n>=o&&n<=s){let e=d(n).toFixed(1);p.push(`<line class="dsh-pm-gantt-now" x1="`+e+`" y1="28" x2="`+e+`" y2="`+(f-10)+`"><title>现在</title></line>`)}p.push(`</svg>`);let h=`<div class="dsh-pm-gantt-legend">`+L.map(e=>`<span class="dsh-pm-gantt-legend-item"><i data-status="`+e+`"></i>`+l[e]+`</span>`).join(``)+`<span class="dsh-pm-gantt-legend-item"><i class="mile"></i>需求里程碑</span></div>`;return`<div class="dsh-pm-gantt-wrap">`+p.join(``)+`</div>`+h}function te(e,t){return`<table class="dsh-pm-ttable"><thead><tr><th>任务</th><th>标题</th><th>状态</th><th>阶段</th><th>端侧</th><th>依赖</th><th>创建</th><th>耗时</th></tr></thead><tbody>`+[...e].sort((e,t)=>e.createdAt-t.createdAt).map(e=>{let n=N(e,`todo`),i=n[0].at,a=n[n.length-1],o=n.find(e=>e.status===`done`)?.at,s=M(e.status)?`共 `+j((o??a.at)-i):`已用 `+j(t-i);return`<tr class="dsh-pm-trow" data-task="`+r(e.id)+`" data-action="open-task"><td class="dsh-pm-tid">`+r(e.id)+`</td><td class="dsh-pm-ttitle">`+r(e.title)+`</td><td><span class="dsh-pm-status" data-status="`+r(e.status)+`">`+(l[e.status]??e.status)+`</span></td><td>`+r(u[e.phase]??e.phase)+`</td><td>`+r(e.side)+`</td><td class="dsh-pm-tdeps">`+(e.dependsOn.length>0?r(e.dependsOn.join(` `)):`—`)+`</td><td>`+r(m(i))+`</td><td>`+r(s)+`</td></tr>`}).join(``)+`</tbody></table>`}function ne(e,t=Date.now()){let n=e.requirements.map(t=>({req:t,tasks:e.tasks.filter(e=>e.requirementId===t.id)})).filter(e=>e.tasks.length>0).sort((e,t)=>t.req.updatedAt-e.req.updatedAt),i=`<div class="dsh-pm-head"><button type="button" class="dsh-pm-btn" data-action="back" title="返回泳道看板">← 看板</button><h1 class="dsh-pm-title">任务</h1><span class="dsh-pm-rev">`+e.tasks.length+` 个任务 · `+n.length+` 个需求 · rev `+e.revision+`</span><button type="button" class="dsh-pm-btn" data-action="refresh" title="刷新">刷新</button></div>`;if(n.length===0)return`<div class="dsh-pm-board">`+i+`<div class="dsh-pm-empty">还没有任务。两种来源：① 需求详情页点「+ 任务」人工建卡；② 窗口 agent 调用 reqboard_decompose 真拆分落库（推荐，含依赖 DAG）</div></div>`;let a=n.map(e=>{let n=e.tasks.filter(e=>e.status===`done`).length;return`<div class="dsh-pm-tasks-group"><div class="dsh-pm-tasks-group-head"><span class="dsh-pm-card-id">`+r(e.req.id)+`</span><span class="dsh-pm-status" data-status="`+r(e.req.status)+`">`+(c[e.req.status]??e.req.status)+`</span><span class="dsh-pm-tasks-group-title">`+r(e.req.title)+`</span><span class="dsh-pm-hint">`+n+`/`+e.tasks.length+` 完成</span><button type="button" class="dsh-pm-btn sm" data-action="open-req" data-req="`+r(e.req.id)+`">打开需求</button></div>`+I(e.req)+`<div class="dsh-pm-detail-section"><h3>甘特图</h3>`+V(e.req,e.tasks,t)+`</div><div class="dsh-pm-detail-section"><h3>任务清单</h3>`+te(e.tasks,t)+`</div></div>`}).join(``);return`<div class="dsh-pm-board">`+i+`<div class="dsh-pm-tasks-page">`+a+`</div></div>`}function re(e,t){let n=N(e,`draft`),i=n[0],a=n[n.length-1],o=[`创建 `+m(i.at)];return a.status!==i.status&&o.push((c[a.status]??a.status)+` `+m(a.at)),M(a.status)||o.push(`已停留 `+j(t-a.at)),`<div class="dsh-pm-card-time">`+r(o.join(` · `))+`</div>`}function ie(e){let t=e.plan;return t===void 0?``:t.approvedAt===void 0?t.rejectedAt===void 0?`<span class="dsh-pm-flag plan-pending" title="实施计划已提交，等待人批准后才能拆分">计划待批</span>`:`<span class="dsh-pm-flag plan-rejected" title="实施计划被退回，待重写">计划被退</span>`:`<span class="dsh-pm-flag plan-ok" title="实施计划已批准，可拆分落库">计划已批</span>`}function ae(e){let t=e.plan;if(t===void 0)return`<div class="dsh-pm-plan is-empty">尚未提交实施计划。计划模式：窗口 agent 用 <code>reqboard_plan_submit</code> 先提交计划（文档路径 + 摘要 + 任务表），人在此处批准后才允许 <code>reqboard_decompose</code> 落库任务卡——拆分的粒度在人点头之前就已写死在计划里。</div>`;let n=t.approvedAt===void 0?t.rejectedAt===void 0?`<span class="dsh-pm-plan-status" data-state="pending">待批准</span>`:`<span class="dsh-pm-plan-status" data-state="rejected">已退回 `+r(m(t.rejectedAt))+`</span>`:`<span class="dsh-pm-plan-status" data-state="approved">已批准 `+r(m(t.approvedAt))+`</span>`,i=t.approvedAt===void 0?`<button type="button" class="dsh-pm-btn sm primary" data-action="plan-approve" data-id="`+r(e.id)+`">批准计划</button><button type="button" class="dsh-pm-btn sm" data-action="plan-reject" data-id="`+r(e.id)+`">退回计划</button>`:`<span class="dsh-pm-hint">拆分已解锁：窗口可用 reqboard_decompose 按此计划落库任务卡</span>`,a=t.tasks.map(e=>{let t=(e.dependsOn??[]).length>0?` · 依赖 `+r((e.dependsOn??[]).join(`,`)):``;return`<div class="dsh-pm-plan-task"><span class="dsh-pm-plan-key">`+r(e.key)+`</span><span class="dsh-pm-plan-title">`+r(e.title)+`</span><span class="dsh-pm-plan-meta">`+r(u[e.phase??`implement`]??e.phase??``)+` / `+r(e.side??``)+t+`</span>`+(e.acceptance!==void 0&&e.acceptance.length>0?`<span class="dsh-pm-plan-accept">验收：`+r(e.acceptance)+`</span>`:`<span class="dsh-pm-plan-accept missing">缺验收标准</span>`)+`</div>`}).join(``);return`<div class="dsh-pm-plan"><div class="dsh-pm-plan-head">`+n+`<code class="dsh-pm-plan-path">`+r(t.path)+`</code><span class="dsh-pm-hint">提交 `+r(m(t.submittedAt))+` · `+t.tasks.length+` 个任务</span>`+i+`</div><div class="dsh-pm-plan-summary">`+r(t.summary)+`</div>`+(t.rejectedReason===void 0?``:`<div class="dsh-pm-plan-reason">退回理由：`+r(t.rejectedReason)+`</div>`)+`<div class="dsh-pm-plan-tasks">`+a+`</div></div>`}const H=8e3;var U=class extends Error{code;constructor(e,t){super(e),this.code=t}};async function W(e){let t=await e;if(!t.ok)throw new U(`HTTP `+t.status);let n=await t.json().catch(()=>({}));if(n.success!==!0)throw new U(n.error??`API 返回失败`,n.code);return n.data}const G=e=>W(fetch(e,{signal:AbortSignal.timeout(H)})),K=(e,t)=>W(fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t),signal:AbortSignal.timeout(H)})),q=()=>G(`/dashboard/api/reqboard/`),oe=()=>G(`/dashboard/api/reqboard/triage`);function se(e){return K(`/dashboard/api/reqboard/req/create`,e)}function ce(e){return K(`/dashboard/api/reqboard/req/move`,e)}function le(e){return K(`/dashboard/api/reqboard/req/plan/approve`,e)}function ue(e){return K(`/dashboard/api/reqboard/req/plan/reject`,e)}function de(e){return K(`/dashboard/api/reqboard/task/create`,e)}function fe(e){return K(`/dashboard/api/reqboard/comment`,e)}function J(e){return K(`/dashboard/api/reqboard/triage/confirm`,e)}function pe(e){return K(`/dashboard/api/reqboard/triage/rebind`,e)}function me(e){return K(`/dashboard/api/reqboard/triage/reject`,e)}function he(e){let t=new EventSource(`/dashboard/api/reqboard/events`);return t.onmessage=t=>{try{let n=JSON.parse(t.data);e(n.revision,n.kind)}catch{}},()=>t.close()}function ge(){let e=()=>window;return{getSessions:()=>{try{let t=e().__dshPmSessions??e().__dshPmCtx?.sessions;if(t&&typeof t.open==`function`&&t.list)return t}catch{}},getWorkspaces:()=>{try{let t=e().__dshPmWorkspaces??e().__dshPmCtx?.workspaces;if(t&&t.list)return t}catch{}}}}async function _e(e,t){let n=e.getSessions();if(n===void 0)return`unavailable`;let r=e=>{try{return n.list.getSnapshot().byId[e]!==void 0}catch{return!1}};if(r(t))return(e.getWorkspaces()?.list.getSnapshot().archivedSessionIds??[]).includes(t)?`archived`:(n.open(t),`opened`);try{await n.refresh()}catch{}return r(t)?(e.getWorkspaces()?.list.getSnapshot().archivedSessionIds??[]).includes(t)?`archived`:(n.open(t),`opened`):`missing`}function Y(){return{openBoard:()=>{},closeBoard:()=>{},toggleBoard:()=>{},getSnapshot:()=>({boardOpen:!1}),refresh:()=>{}}}function ve(e){let t,n=[],r={kind:`board`},o,c,l=()=>{if(o!==void 0){if(t===void 0){o.innerHTML=k();return}switch(r.kind){case`board`:o.innerHTML=_(t);break;case`req`:{let e=t.requirements.find(e=>e.id===r.reqId);o.innerHTML=e?S(e,t.tasks):_(t),e||(r={kind:`board`});break}case`task`:{let e=t.tasks.find(e=>e.id===r.taskId),n=e?t.requirements.find(t=>t.id===e.requirementId):void 0;o.innerHTML=e?D(e,n):_(t),e||(r={kind:`board`});break}case`tasks`:o.innerHTML=ne(t);break;case`triage`:o.innerHTML=O(n,t)}}},u=async()=>{try{let[e,r]=await Promise.all([q(),oe()]);t=e,n=r.pending,l()}catch(e){o!==void 0&&(o.innerHTML=A(String(e)))}},d=()=>{c?.(),c=he(()=>{u()})},f=e=>{let i=e.target.closest(`[data-action]`);if(i!==null&&t!==void 0)switch(i.dataset.action??``){case`refresh`:u();return;case`new-req`:{let e=window.prompt(`需求标题`);e&&e.trim()&&se({title:e.trim()}).then(()=>u()).catch(e=>window.alert(String(e)));return}case`open-req`:i.dataset.req&&(r={kind:`req`,reqId:i.dataset.req},l());return;case`open-task`:i.dataset.task&&(r={kind:`task`,taskId:i.dataset.task},l());return;case`open-tasks`:r={kind:`tasks`},l();return;case`new-task`:{let e=i.dataset.id;if(!e)return;let t=window.prompt(`任务标题`);t&&t.trim()&&de({requirementId:e,title:t.trim(),phase:`implement`,side:`fullstack`}).then(()=>u()).catch(e=>window.alert(String(e)));return}case`back`:r={kind:`board`},l();return;case`back-req`:r={kind:`req`,reqId:i.dataset.req??``},l();return;case`move-req`:{let e=i.dataset.id??(r.kind===`req`?r.reqId:void 0),t=i.dataset.to;e&&t&&ce({id:e,to:t,actor:`human`,reason:i.dataset.id?`看板泳道卡面操作`:`需求详情页操作`}).then(()=>u()).catch(e=>window.alert(String(e)));return}case`add-comment`:{let e=(o?.querySelector(`[data-role="comment-input"]`))?.value.trim();e&&i.dataset.target&&i.dataset.id&&fe({target:i.dataset.target,id:i.dataset.id,body:e,actor:`human`}).then(()=>u()).catch(e=>window.alert(String(e)));return}case`jump-session`:{let e=i.dataset.sid;e&&_e(ge(),e).then(e=>{e===`archived`?window.alert(`该会话已归档（日志保留，侧栏不可见）`):e===`missing`?window.alert(`该会话不在当前列表（可能已删除）`):e===`unavailable`&&window.alert(`会话服务暂不可用`)});return}case`plan-approve`:{let e=i.dataset.id;e&&le({id:e}).then(()=>u()).catch(e=>window.alert(String(e)));return}case`plan-reject`:{let e=i.dataset.id;if(!e)return;let t=window.prompt(`退回理由（窗口会按它重写计划）`);if(t===null)return;ue({id:e,reason:t.trim()||`（未填理由）`}).then(()=>u()).catch(e=>window.alert(String(e)));return}case`triage-confirm`:{let e=i.dataset.triage;if(!e)return;let t=n.find(t=>t.id===e);if(t?.suggestedAction===`bind_req`&&t.suggestedTargetId)J({triageId:e,action:`bind_req`,targetId:t.suggestedTargetId}).then(()=>u()).catch(e=>window.alert(String(e)));else{let t=i.closest(`.dsh-pm-triage`),n=t?.querySelector(`[data-role="triage-title"]`)?.value.trim(),r=t?.querySelector(`[data-role="triage-category"]`)?.value;J({triageId:e,action:`create_req`,...n?{title:n}:{},...r?{category:r}:{}}).then(()=>u()).catch(e=>window.alert(String(e)))}return}case`triage-rebind`:{let e=o?.querySelector(`.dsh-pm-rebind-host`);e&&(e.style.display=`flex`,e.dataset.triage=i.dataset.triage??``);return}case`triage-rebind-confirm`:{let e=o?.querySelector(`.dsh-pm-rebind-host`),t=e?.dataset.triage,n=e?.querySelector(`[data-role="rebind-select"]`);t&&n?.value&&pe({triageId:t,targetId:n.value}).then(()=>u()).catch(e=>window.alert(String(e)));return}case`triage-reject`:{let e=i.dataset.triage;e&&me({triageId:e}).then(()=>u()).catch(e=>window.alert(String(e)));return}}},p=i({prefix:`dsh-pm`,panelName:a,activeAttr:`data-dsh-pm-active`,otherActiveAttrs:s,pollMs:2e4,pauseOnHidden:!0,buildContainer:()=>{let e=document.createElement(`div`);return e.dataset.dshPmView=``,e.className=`dsh-pm-view`,e},onMount:e=>(o=e,e.addEventListener(`click`,f),u(),d(),()=>{e.removeEventListener(`click`,f),c?.(),c=void 0,o=void 0}),onPoll:()=>{u()},onOpen:()=>{u()}}),m=e;return m.openBoard=p.open,m.closeBoard=p.close,m.toggleBoard=p.toggle,m.getSnapshot=()=>({boardOpen:p.isActive()}),m.refresh=()=>{u()},()=>{p.dispose()}}const X=`dsh-pmboard/footer-action.css`,Z=`dsh-pmboard:open-board`,Q=(0,e.createElement)(`svg`,{viewBox:`0 0 16 16`,width:`16`,height:`16`,fill:`none`,stroke:`currentColor`,"stroke-width":`1.4`,"stroke-linecap":`round`,"stroke-linejoin":`round`,"aria-hidden":`true`},(0,e.createElement)(`rect`,{x:`2`,y:`2`,width:`5`,height:`5`,rx:`1`}),(0,e.createElement)(`rect`,{x:`9`,y:`2`,width:`5`,height:`5`,rx:`1`}),(0,e.createElement)(`rect`,{x:`2`,y:`9`,width:`5`,height:`5`,rx:`1`}),(0,e.createElement)(`rect`,{x:`9`,y:`9`,width:`5`,height:`5`,rx:`1`}));function ye(){if(typeof document>`u`||document.querySelector(`style[data-plugin-css="${X}"]`))return;let e=document.createElement(`style`);e.dataset.pluginCss=X,e.textContent=`
.dsh-reqboard-foot {
...
`,document.head.appendChild(e)}function be(t){let{wide:n}=t,r=o;return(0,e.createElement)(`button`,{type:`button`,className:n?`dsh-reqboard-foot wide`:`dsh-reqboard-foot rail`,title:r,"aria-label":r,onClick:()=>{window.dispatchEvent(new CustomEvent(Z,{detail:{open:!0}}))}},n?[(0,e.createElement)(`span`,{className:`dsh-reqboard-foot-icon`,key:`i`},Q),(0,e.createElement)(`span`,{className:`dsh-reqboard-foot-label`,key:`l`},r)]:(0,e.createElement)(`span`,{className:`dsh-reqboard-foot-icon`,key:`i`},Q))}const $=`dsh-pmboard/styles.css`;function xe(){if(typeof document>`u`||document.querySelector(`style[data-plugin-css="${$}"]`))return;let e=document.createElement(`style`);e.dataset.pluginCss=$,e.textContent=`
...
`,document.head.appendChild(e)}const Se=[`slots`,`sessions`,`workspaces`];function Ce(e){try{ye(),xe(),window.__dshReqboardClient?.dispose(),window.__dshPmCtx=e,window.__dshPmSessions=e.sessions,window.__dshPmWorkspaces=e.workspaces;let t=Y(),n=ve(t),r=e=>{e.detail?.open===!0?t.getSnapshot().boardOpen?t.closeBoard():t.openBoard():t.toggleBoard()};window.addEventListener(Z,r),window.__dshReqboardClient={dispose:()=>{window.removeEventListener(Z,r),n(),t.closeBoard(),delete window.__dshPmCtx,delete window.__dshPmSessions,delete window.__dshPmWorkspaces}};let i=e.slots;i?i.inject(`sidebar.footer.action`,()=>i.register({name:`sidebar.footer.action`,id:a,order:110,label:o},be)):console.warn(`[dsh-pmboard] ctx.slots unavailable`)}catch(e){console.error(`[dsh-pmboard] client half failed to start:`,e)}}exports.apply=Ce,exports.inject=Se,exports.name=`dsh-pmboard/client`;