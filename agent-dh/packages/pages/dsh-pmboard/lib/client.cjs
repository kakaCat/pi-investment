...
`,document.head.appendChild(e)}const rr=[`slots`,`sessions`,`workspaces`,`sidebarRight`];function ir(e){try{Yn(),nr(),window.__dshReqboardClient?.dispose(),window.__dshPmCtx=e,window.__dshPmSessions=e.sessions,window.__dshPmWorkspaces=e.workspaces;let t=Wn(),n=Gn(t),r=e=>{e.detail?.open===!0?t.getSnapshot().boardOpen?t.closeBoard():t.openBoard():t.toggleBoard()};window.addEventListener(Q,r),window.__dshReqboardClient={dispose:()=>{window.removeEventListener(Q,r),n(),t.closeBoard(),delete window.__dshPmCtx,delete window.__dshPmSessions,delete window.__dshPmWorkspaces}};let i=e.slots;if(i){try{i.inject(`sidebar.footer.action`,()=>i.register({name:`sidebar.footer.action`,id:o,order:110,label:s},Xn))}catch(e){console.error(`[dsh-pmboard] Failed to register sidebar.footer.action:`,e)}try{i.inject(`conversation.session.header.utilities`,()=>i.register({name:`conversation.session.header.utilities`,id:`dsh-pmboard:progress`,order:5,inject:e=>({sessionId:e})},er))}catch(e){console.error(`[dsh-pmboard] Failed to register conversation.session.header.utilities:`,e)}}else console.warn(`[dsh-pmboard] ctx.slots unavailable`)}catch(e){console.error(`[dsh-pmboard] client half failed to start:`,e)}}exports.apply=ir,exports.inject=rr,exports.name=`dsh-pmboard/client`;