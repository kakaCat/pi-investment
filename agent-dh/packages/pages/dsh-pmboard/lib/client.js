...
`)}function C(e){let t=e.createdBy,n=t?.kind??`human`;if(n===`human`)return{actor:`human`,text:`人`};if(n===`system`)return{actor:`system`,text:`系统`};let r=t?.sessionId;return{actor:`agent`,text:r!==void 0&&r.length>0?`窗口 `+m(r):`窗口`}}function w(e){return e.length===0?`<div class="dsh-pm-empty">暂无评论</div>`:`<div class="dsh-pm-comments">`+e.map(e=>{let t=C(e);return`
    ...
    </div>`,c=n===`list`?Ve(e,t,r,i):`<div class="dsh-pm-lanes">${o}</div>`;return`
    ...
    </div>`}const Ge={draft:{label:`立项`,color:`#9aa4b2`,order:0},brainstorming:{label:`需求分析`,color:`#f0a020`,order:1},design:{label:`设计`,color:`#c2255c`,order:2},decomposing:{label:`拆分`,color:`#8e44ad`,order:3},implementing:{label:`实施`,color:`#4a7dff`,order:4},accepting:{label:`验收`,color:`#17a2b8`,order:5},done:{label:`完成`,color:`#28a745`,order:6},archived:{label:`归档`,color:`#28a745`,order:7}},Ke=[`draft`,`brainstorming`,`design`,`decomposing`,`implementing`,`accepting`,`done`,`archived`];function qe(e){return Ge[e]?.order??-1}function Je(e){return e!==void 0&&e.length>0}function Ye(e){return l[e]??e}function Xe(e){return Array.isArray(e.fragmentIds)?e.fragmentIds:[]}function Ze(e){let t=Xe(e);return`<div class="dsh-pm-injection-row" data-stage="${r(e.stage)}">
    ...
    </div>`}function G(e){if(e.length===0)return`<div class="dsh-pm-injection-info"><div class="dsh-pm-empty">尚无记录</div></div>`;let t=e.slice().reverse().map(Ze).join(``);return`<div class="dsh-pm-injection-info" data-count="${e.length}">
      <div class="dsh-pm-injection-info-head">本次注入（最近 ${e.length} 条）</div>
      ${t}
    </div>`}const Qe={draft:`📝 立项`,brainstorming:`🔍 需求分析`,design:`🧩 设计`,decomposing:`🪓 拆分`,implementing:`🔨 实施`,accepting:`✅ 验收`,archived:`📦 归档`,done:`✅ 验收`};function $e(e){return Qe[e]??e}function K(e){return e===void 0?`无快照`:e.source===`unavailable`?`无快照（当时未取到会话投影）`:`未缓存输入 ${B(e.totals.uncachedInputTokens)} · 输出 ${B(e.totals.outputTokens)} · 缓存读 ${B(e.totals.cacheReadTokens)}`}function et(e){let t=e.totals;return`<div class="dsh-pm-stats">
    ...
    </details>`}function rt(e,t){return`<details class="dsh-pm-prompt"><summary><span class="dsh-pm-prompt-name">${r(t===void 0?e.name:t)}</span><span class="dsh-pm-prompt-meta">${`${r(String(e.chars))} 字符 · ${r(B(e.estTokens))}`}</span></summary>${e.text!==void 0&&e.text.length>0?`<pre class="dsh-pm-prompt-text">${r(e.text)}</pre>`:`<div class="dsh-pm-note">（本条目不含正文）</div>`}</details>`}function it(e){if(e===void 0||e.source===`unavailable`)return`<details class="dsh-pm-fold"><summary>🧱 固定系统提示词<span class="dsh-pm-fold-count">不可用</span></summary><div class="dsh-pm-fold-body"><div class="dsh-pm-empty">系统提示词装配服务不可得，未取到（不猜数字）。</div></div></details>`;let t=e.cumulativeEstTokens===void 0?`累计：回合数不可得`:`累计 ≈ ${r(B(e.cumulativeEstTokens))}`,n=[...e.sections,...e.contexts].map(e=>rt(e)).join(``),i=e.toolsChars>0?`<div class="dsh-pm-note">工具 schema 文字化成本：${r(String(e.toolsChars))} 字符 · ${r(B(Math.ceil(e.toolsChars/4)))}（估算）</div>`:``;return`<details class="dsh-pm-fold"><summary>🧱 固定系统提示词<span class="dsh-pm-fold-count">每回合 ≈ ${r(B(e.perTurnEstTokens))}</span></summary><div class="dsh-pm-fold-body"><div class="dsh-pm-sum"><span>本次装配：<b>${r(String(e.perTurnChars))}</b> 字符</span><span>每回合 ≈ <b>${r(B(e.perTurnEstTokens))}</b> tokens</span><span>回合数：<b>${r(String(e.turns))}</b></span><span>${t}</span><span>来源：systemPrompt.assemble（实时，估算）</span></div><div class="dsh-pm-note">点开每一段可看**具体提示词内容**（只读）。</div>${n}${i}</div></details>`}function at(e){if(e===void 0||e.count===0)return`<details class="dsh-pm-fold"><summary>💉 注入提示词<span class="dsh-pm-fold-count">无记录</span></summary><div class="dsh-pm-fold-body"><div class="dsh-pm-empty">本需求窗口暂无注入留痕（或无可匹配窗口，不做张冠李戴的归因）。</div></div></details>`;let t=e.sharePct===void 0?``:` · 占本需求 ${r(String(e.sharePct))}%`,n=e.byStage.map(t=>{let n=Math.max(...e.byStage.map(e=>e.estTokens),1),i=Math.round(t.estTokens/n*100);return`<div class="dsh-pm-impact-row"><span class="dsh-pm-impact-name">${r($e(t.name))}</span><span class="dsh-pm-impact-bar"><i style="width:${i}%"></i></span><span class="dsh-pm-impact-val">${r(B(t.estTokens))}</span></div>`}).join(``),i=e.items.map(e=>`<details class="dsh-pm-prompt"><summary><span class="dsh-pm-prompt-name">${r(h(e.at))} · ${r(e.routeKey)}</span><span class="dsh-pm-prompt-meta">${r(String(e.chars))} 字符 · ${r(B(e.estTokens))}</span></summary><div class="dsh-pm-note">命中片段：${r(e.fragmentIds.join(`, `))||`—`}</div></details>`).join(``);return`<details class="dsh-pm-fold"><summary>💉 注入提示词<span class="dsh-pm-fold-count">${r(String(e.count))} 次 · ${r(B(e.estTokens))}（估算）${t}</span></summary><div class="dsh-pm-fold-body"><div class="dsh-pm-sum"><span>注入次数：<b>${r(String(e.count))}</b></span><span>累计字符：<b>${r(String(e.chars))}</b></span><span>估算 Token：<b>${r(B(e.estTokens))}</b></span>${t}</div>`+n+`<div class="dsh-pm-note">明细（点开看每次注入的命中片段）：</div>`+i+`</div></details>`}function ot(e){return et(e)+tt(e)+nt(e)+it(e.systemPrompt)+at(e.injections)}function st(e){return`<div class="dsh-pm-empty">${r(e)}</div>`}const ct={done:{text:`✅ 已完成（有证据）`,cls:`dsh-pm-mk-done`},received:{text:`✅ 已接收`,cls:`dsh-pm-mk-received`},skipped:{text:`⏭ 本轮裁剪`,cls:`dsh-pm-mk-skipped`},unreceived:{text:`🔴 未被接收`,cls:`dsh-pm-mk-unreceived`}};function q(e){return`<div class="dsh-pm-note">`+r(e)+`</div>`}function lt(e){if(!e.available)return q(`读不到条款数据（需求文档缺失）——这不等于"全部未被接收"`);if(e.clauses.length===0)return q(`本需求文档尚未定义功能点根编号（§6 功能点用 FR-# 定义，才能逐条追踪）`);let t=e.unreceived.length;return(t===0?N(`<div class="dsh-pm-mk-sum">共 {n} 条功能点，全部有落点。</div>`,{n:e.clauses.length}):N(`<div class="dsh-pm-mk-sum dsh-pm-mk-alert">🔴 未被接收 {n} 条：{list}</div>`,{n:t,list:r(e.unreceived.join(`、`))}))+N(`<table class="dsh-pm-mk-table"><thead><tr><th>编号</th><th>接收状态</th><th>承载任务</th></tr></thead><tbody>{rows}</tbody></table>`,{rows:e.clauses.map(e=>{let t=ct[e.state],n=e.state===`unreceived`?`dsh-pm-mk-row is-unreceived`:`dsh-pm-mk-row`,i=e.by.length>0?r(e.by.join(`、`)):`—`;return`<tr class="`+n+`"><td class="dsh-pm-mk-id">`+r(e.clause)+`</td><td class="`+t.cls+`">`+t.text+`</td><td class="dsh-pm-mk-by">`+i+`</td></tr>`}).join(``)})}function ut(e){let t=qe(e);return`<div class="dsh-pm-progress-dots">${Ke.map(e=>{let{label:n,order:i}=Ge[e];return`
    ...
    <div class="dsh-pm-detail" data-detail-req="${r(e.id)}">
      ...
      ${dt()}
      ${ft(e,a,o,s,n)}
    </div>`}function mt(e){let t={draft:`已立项：窗口接手开工后自动进入需求分析，人可在上方操作条手动催办。`,brainstorming:`需求分析中：窗口 agent 会自行推进到设计，人可在上方操作条确认方案或退回立项。`,design:`设计中：计划提交后请在上方操作条点「批准计划」——批准前拆分会被告代码级拒绝。`,decomposing:`拆分中：任务落库/开工后系统自动推进到实施，人可在上方操作条确认拆分。`,implementing:`实施中：任务全部完成时自动进入验收，人可在上方操作条提交验收。`,accepting:`验收中：看完验收材料后，在上方操作条点「验收通过」或「退回返工」。`,done:`已完成（历史状态）：验收通过现已直接归档，此状态仅存在于旧记录。`}[e];return t===void 0?``:`<div class="dsh-pm-gate">`+t+`</div>`}function ht(e){let t=[],n=[],i=(n,i,a,o=!1)=>{let s=o?`dsh-pm-btn primary`:`dsh-pm-btn`;t.push(`<button type="button" class="`+s+`" data-action="`+n+`" data-id="`+r(e.id)+`" title="`+r(a)+`">`+i+`</button>`)},a=(n,i,a,o=!1)=>{let s=o?`dsh-pm-btn primary`:`dsh-pm-btn`;t.push(`<button type="button" class="`+s+`" data-action="move-req" data-to="`+n+`" data-id="`+r(e.id)+`" title="`+r(a)+`">`+i+`</button>`)};switch(e.status){case`draft`:a(`brainstorming`,`→ 需求分析`,`进入需求分析；窗口接手开工时会自动进入`,!0),a(`canceled`,`取消`,`取消该需求（仅人可操作）`);break;case`brainstorming`:a(`design`,`→ 设计`,`方案谈定 → 进入设计；请提交计划并待批准`,!0),a(`draft`,`退回立项`,`方案要重谈 → 退回立项`);break;case`design`:a(`decomposing`,`→ 拆分`,`计划获批后落库任务卡；未获批会被代码级拒绝`,!0),a(`brainstorming`,`退回重谈`,`方案要改 → 退回需求分析`);break;case`decomposing`:a(`implementing`,`→ 实施`,`确认拆分，进入实施；任务开工时系统会自动推进`,!0);break;case`implementing`:a(`accepting`,`→ 验收`,`提交验收；任务全部完成时系统会自动推进`,!0)}if(e.status!==`draft`&&e.status!==`done`&&e.status!==`canceled`&&e.status!==`archived`&&a(`canceled`,`取消`,`取消该需求（仅人可操作）`),e.plan!==void 0&&e.plan.approvedAt===void 0&&(i(`plan-approve`,`批准计划`,`批准拆分计划，解锁 reqboard_decompose 拆分`,!0),i(`plan-reject`,`退回计划`,`退回拆分计划（窗口按理由重写）`)),e.status===`accepting`&&(i(`verify-pass`,`验收通过`,`人工审核通过（有不合格项或未交材料时会先弹确认框）`,!0),i(`verify-rework`,`退回返工`,`退回返工（需填写意见）`)),e.status===`done`&&e.archive!==void 0&&e.archive.archivedAt===void 0&&i(`archive-req`,`归档`,`归档：把产出并进项目文档`,!0),t.length===0&&n.length===0)return``;let o=n.length===0?``:`<span class="dsh-pm-action-bar-label">`+r(n.join(`；`))+`</span>`;return`<div class="dsh-pm-action-bar" data-req="`+r(e.id)+`"><span class="dsh-pm-action-bar-label">本阶段操作</span>`+o+t.join(``)+`</div>`}function gt(e){if(e.length===0)return`<div class="dsh-pm-empty">暂无任务</div>`;let t=new Map,n=new Map(e.map(e=>[e.id,e])),i=(e,r)=>{if(t.has(e.id))return t.get(e.id);if(r.has(e.id))return 0;r.add(e.id);let a=e.dependsOn.filter(e=>n.has(e)),o=a.length===0?0:1+Math.max(...a.map(e=>i(n.get(e),r)));return t.set(e.id,o),o};e.forEach(e=>i(e,new Set));let a=Math.max(...t.values()),o=Array.from({length:a+1},()=>[]);return e.forEach(e=>o[t.get(e.id)].push(e)),`<div class="dsh-pm-dag"><div class="dsh-pm-dag-title">🔀 任务依赖关系</div><div class="dsh-pm-dag-layers">`+o.map((e,t)=>`
...
`+(s.length>0?s.join(`
`)+`
`:``)+`确认后按「覆盖通过」归档（会留下覆盖记录），是否继续？`,overrideDetail:`看板覆盖通过：验收单 v`+o+`，不通过 `+i.length+` 项 / 未裁决 `+a+` 项`}}const Vn=`dsh-pmboard:view`;function Hn(){try{return sessionStorage.getItem(Vn)===`list`?`list`:`lanes`}catch{return`lanes`}}function Un(e){try{sessionStorage.setItem(Vn,e)}catch{}}const Wn=`dsh-pmboard:list`,Gn=[`stage`,`progress`,`updated`,`created`,`title`];function Kn(){let e={sortKey:`stage`,sortDir:`asc`,pageSize:10};try{let t=sessionStorage.getItem(Wn);if(t===null)return e;let n=JSON.parse(t),r=typeof n.sortKey==`string`&&Gn.includes(n.sortKey)?n.sortKey:e.sortKey;return{sortKey:r,sortDir:n.sortDir===`asc`||n.sortDir===`desc`?n.sortDir:W(r),pageSize:typeof n.pageSize==`number`&&U.includes(n.pageSize)?n.pageSize:10}}catch{return e}}function qn(e,t){let n=t.length>18?t.slice(0,18)+`…`:t;switch(e){case`archived`:return`该会话已归档（`+n+`）：日志保留、侧栏不可见，无法跳转`;case`missing`:return`该会话不在当前会话列表（`+n+`）：可能已删除或不在当前工作区`;case`unavailable`:return`会话服务暂不可用（页面注入未就绪），请刷新页面后重试`;case`opened`:return``;default:return`会话跳转结果未知：`+String(e)}}function Jn(){return{openBoard:()=>{},closeBoard:()=>{},toggleBoard:()=>{},getSnapshot:()=>({boardOpen:!1}),refresh:()=>{}}}function Yn(e){let t,n=[],r={kind:`board`},a=Hn(),s=Kn(),l=s.sortKey,u=s.sortDir,d=s.pageSize,f=1,p,m,h,g=()=>({sortKey:l,sortDir:u,page:f,pageSize:d}),_=()=>dn(),v=()=>{try{sessionStorage.setItem(Wn,JSON.stringify({sortKey:l,sortDir:u,pageSize:d}))}catch{}},y=e=>{m!==void 0&&m.querySelectorAll(`[data-action="load-stage"]`).forEach(t=>{e!==void 0&&t.dataset.stage===e?t.setAttribute(`data-active`,`true`):t.removeAttribute(`data-active`)})},b=()=>{if(m===void 0)return;if(t===void 0){m.innerHTML=T();return}let e=r;switch(e.kind){case`board`:m.innerHTML=H(t,Date.now(),a,g(),_());break;case`req`:{let n=t.requirements.find(t=>t.id===e.reqId);m.innerHTML=n?pt(n,t.tasks,Date.now(),_()):H(t,Date.now(),a,g(),_()),n?(y(p),D(),O(n.id,n.status),k(n.sourceSessionId),j(n.id),N(n.id)):r={kind:`board`};break}case`task`:{let n=t.tasks.find(t=>t.id===e.taskId),i=n?t.requirements.find(e=>e.id===n.requirementId):void 0;m.innerHTML=n?Dt(n,i,Date.now(),t.tasks,_()):H(t,Date.now(),a,g(),_()),n||(r={kind:`board`});break}case`tasks`:m.innerHTML=he(t);break;case`triage`:m.innerHTML=We(n,t)}},x=async()=>{try{let[e,r]=await Promise.all([Ft(),It()]);t=e,n=r.pending,b()}catch(e){m!==void 0&&(m.innerHTML=E(String(e)))}},S=()=>{h?.(),h=nn(()=>{x()})},C=e=>{let i=e.target,o=i.closest(`[data-pmpage]`);if(o!==null&&t!==void 0){let e=Number(o.dataset.pmpage);Number.isFinite(e)&&e>=1&&(f=e,b());return}let s=i.closest(`[data-action]`);if(s!==null&&t!==void 0)switch(s.dataset.action??``){case`refresh`:x();return;case`switch-view`:{let e=s.dataset.view;(e===`lanes`||e===`list`)&&(a=e,Un(e),r={kind:`board`},b());return}case`list-sort`:{let e=s.dataset.key;if(e===void 0||!Gn.includes(e))return;e===l?u=u===`asc`?`desc`:`asc`:(l=e,u=W(e)),f=1,v(),b();return}case`open-doc`:{let e=s.dataset.path;e&&ln(window.__dshPmCtx,e,cn());return}case`switch-tab`:{let e=i.closest(`.dsh-pm-tab`);if(!e)return;let t=e.dataset.tab;if(!t)return;let n=e.closest(`.dsh-pm-detail`);if(!n)return;n.querySelectorAll(`.dsh-pm-tab`).forEach(e=>{e.classList.remove(`active`)}),e.classList.add(`active`),n.querySelectorAll(`.dsh-pm-tab-content`).forEach(e=>{e.classList.remove(`active`)});let r=n.querySelector(`.dsh-pm-tab-content[data-tab-content="${t}"]`);if(r&&r.classList.add(`active`),t===`token`){let e=n.dataset.detailReq;e!==void 0&&e.length>0&&j(e)}return}case`toggle-token-node`:{let e=s.closest(`.dsh-pm-tok-node`),t=e?.dataset.stage;if(e===null||t===void 0)return;e.closest(`table`)?.querySelectorAll(`.dsh-pm-tok-sub`).forEach(e=>{e.dataset.parentStage===t&&(e.style.display=e.style.display===`none`?``:`none`)});return}case`load-stage`:{let e=s.dataset.req,t=s.dataset.stage;e&&t&&(p=t,y(t),O(e,t));return}case`confirm-artifact`:{let e=s.dataset.id,t=s.dataset.kind;e&&t&&Xt({id:e,kind:t}).then(()=>x()).catch(e=>window.alert(String(e)));return}case`submit-verdicts`:{let e=s.dataset.req,t=Number(s.dataset.version),n=s.closest(`.dsh-pm-vsheet`);if(!e||!Number.isFinite(t)||n===null)return;let r=[];if(n.querySelectorAll(`.dsh-pm-vitem`).forEach(e=>{let t=e.dataset.itemId;if(t===void 0)return;let n=e.querySelector(`input[type="radio"]:checked`);if(n===null)return;let i=e.querySelector(`.dsh-pm-vitem-opinion`)?.value.trim()??``;r.push({itemId:t,status:n.value===`passed`?`passed`:`failed`,...i.length>0?{opinion:i}:{}})}),r.length===0){window.alert(`请先逐项选择 通过/不通过`);return}Wt({id:e,version:t,verdicts:r}).then(()=>x()).catch(e=>window.alert(String(e)));return}case`new-req`:{let e=window.prompt(`需求标题`);e&&e.trim()&&Rt({title:e.trim()}).then(()=>x()).catch(e=>window.alert(String(e)));return}case`open-req`:s.dataset.req&&(p=void 0,r={kind:`req`,reqId:s.dataset.req},b());return;case`open-task`:s.dataset.task&&(r={kind:`task`,taskId:s.dataset.task},b());return;case`open-tasks`:p=void 0,r={kind:`tasks`},b();return;case`new-task`:{let e=s.dataset.id;if(!e)return;let t=window.prompt(`任务标题`);t&&t.trim()&&Zt({requirementId:e,title:t.trim(),phase:`implement`,side:`fullstack`}).then(()=>x()).catch(e=>window.alert(String(e)));return}case`back`:p=void 0,r={kind:`board`},b();return;case`back-req`:p=void 0,r={kind:`req`,reqId:s.dataset.req??``},b();return;case`move-req`:{let e=s.dataset.id??(r.kind===`req`?r.reqId:void 0),t=s.dataset.to;e&&t&&zt({id:e,to:t,actor:`human`,reason:s.dataset.id?`看板泳道卡面操作`:`需求详情页操作`}).then(()=>x()).catch(e=>window.alert(String(e)));return}case`add-comment`:{let e=(m?.querySelector(`[data-role="comment-input"]`))?.value.trim();e&&s.dataset.target&&s.dataset.id&&Qt({target:s.dataset.target,id:s.dataset.id,body:e,actor:`human`}).then(()=>x()).catch(e=>window.alert(String(e)));return}case`jump-session`:{let e=s.dataset.sid;if(!e)return;if(s.dataset.archived===`true`){window.alert(qn(`archived`,e));return}fn(un(),e).then(t=>{let n=qn(t,e);n!==``&&window.alert(n)}).catch(e=>window.alert(`会话跳转失败：`+String(e)));return}case`verify-pass`:{let e=s.dataset.id;if(!e)return;let n=t?.requirements.find(t=>t.id===e),r=Bn(n);if(!window.confirm(r.message))return;Ht({id:e,...r.overrideDetail===void 0?{}:{confirm_override:r.overrideDetail}}).then(()=>x()).catch(e=>window.alert(String(e)));return}case`verify-rework`:{let e=s.dataset.id;if(!e)return;let t=window.prompt(`退回返工的意见（窗口会按它整改）`);if(t===null)return;Ut({id:e,note:t.trim()||`（未填意见）`}).then(()=>x()).catch(e=>window.alert(String(e)));return}case`archive-req`:{let e=s.dataset.id;e&&Gt({id:e}).then(()=>x()).catch(e=>window.alert(String(e)));return}case`plan-approve`:{let e=s.dataset.id;e&&Bt({id:e}).then(()=>x()).catch(e=>window.alert(String(e)));return}case`plan-reject`:{let e=s.dataset.id;if(!e)return;let t=window.prompt(`退回理由（窗口会按它重写拆分计划）`);if(t===null)return;Vt({id:e,reason:t.trim()||`（未填理由）`}).then(()=>x()).catch(e=>window.alert(String(e)));return}case`triage-confirm`:{let e=s.dataset.triage;if(!e)return;let t=n.find(t=>t.id===e);if(t?.suggestedAction===`bind_req`&&t.suggestedTargetId)$t({triageId:e,action:`bind_req`,targetId:t.suggestedTargetId}).then(()=>x()).catch(e=>window.alert(String(e)));else{let t=s.closest(`.dsh-pm-triage`),n=t?.querySelector(`[data-role="triage-title"]`)?.value.trim(),r=t?.querySelector(`[data-role="triage-category"]`)?.value;$t({triageId:e,action:`create_req`,...n?{title:n}:{},...r?{category:r}:{}}).then(()=>x()).catch(e=>window.alert(String(e)))}return}case`triage-rebind`:{let e=m?.querySelector(`.dsh-pm-rebind-host`);e&&(e.style.display=`flex`,e.dataset.triage=s.dataset.triage??``);return}case`triage-rebind-confirm`:{let e=m?.querySelector(`.dsh-pm-rebind-host`),t=e?.dataset.triage,n=e?.querySelector(`[data-role="rebind-select"]`);t&&n?.value&&en({triageId:t,targetId:n.value}).then(()=>x()).catch(e=>window.alert(String(e)));return}case`triage-reject`:{let e=s.dataset.triage;e&&tn({triageId:e}).then(()=>x()).catch(e=>window.alert(String(e)));return}}},w=e=>{let t=e.target;if(t===null||typeof t.closest!=`function`)return;let n=t.closest(`[data-action="list-size"]`);if(n!==null){let e=Number(n.value);if(!U.includes(e))return;d=e,f=1,v(),b();return}},D=async()=>{if(m===void 0)return;let e=Array.from(m.querySelectorAll(`[data-doc-path]`));if(e.length===0)return;let t=Array.from(new Set(e.map(e=>e.dataset.docPath??``).filter(e=>e.length>0)));if(t.length===0)return;let n;try{n=(await Yt(t)).results??[]}catch{return}let r=new Map(n.map(e=>[e.path,e]));for(let t of e){let e=t.dataset.docPath??``,n=r.get(e);if(n===void 0||n.openable)continue;t.classList.add(`is-missing`),t.setAttribute(`title`,n.reason??`文件不可打开`),t.removeAttribute(`data-doc-path`);let i=t.querySelector(`[data-action="open-doc"]`);i&&(i.removeAttribute(`data-action`),i.classList.add(`dsh-pm-doc-missing`))}},O=async(e,t)=>{let n=document.getElementById(`dsh-pm-stage-detail-container`);if(n!==null){n.innerHTML=`<div class="dsh-pm-empty">详情加载中…</div>`;try{let r=await fetch(`/dashboard/api/reqboard/requirements/`+encodeURIComponent(e)+`/stages`,{signal:AbortSignal.timeout(8e3)});if(!r.ok){n.innerHTML=`<div class="dsh-pm-empty">详情暂不可用（HTTP `+r.status+`）</div>`;return}let i=await r.json();n.innerHTML=i.success===!0&&i.data!==void 0?zn(i.data,t):`<div class="dsh-pm-empty">详情暂不可用</div>`}catch(e){n.innerHTML=`<div class="dsh-pm-empty">详情加载失败：`+String(e)+`</div>`}}},k=async e=>{let t=document.getElementById(`dsh-pm-injection-info-container`);if(t!==null){if(!Je(e)){t.innerHTML=G([]);return}try{let n=await Lt(e);t.innerHTML=G(n.available?n.entries:[])}catch{t.innerHTML=G([])}}},A,j=async e=>{let t=document.getElementById(`dsh-pm-token-container`);if(t!==null&&A!==e)try{t.innerHTML=ot(await qt(e)),A=e}catch{t.innerHTML=st(`Token 数据暂不可用（接口失败或需求不存在）`)}},M,N=async e=>{let t=document.getElementById(`dsh-pm-marks-container`);if(t!==null&&M!==e){M=e;try{t.innerHTML=lt(await Jt(e))}catch{t.innerHTML=q(`接收状态暂不可用（接口失败或需求不存在）`)}finally{M=void 0}}},P=i({prefix:`dsh-pm`,panelName:o,activeAttr:`data-dsh-pm-active`,otherActiveAttrs:c,pollMs:2e4,pauseOnHidden:!0,buildContainer:()=>{let e=document.createElement(`div`);return e.dataset.dshPmView=``,e.className=`dsh-pm-view`,e},onMount:e=>(m=e,e.addEventListener(`click`,C),e.addEventListener(`change`,w),x(),S(),()=>{e.removeEventListener(`click`,C),e.removeEventListener(`change`,w),h?.(),h=void 0,m=void 0}),onPoll:()=>{x()},onOpen:()=>{x()}}),F=e;return F.openBoard=P.open,F.closeBoard=P.close,F.toggleBoard=P.toggle,F.getSnapshot=()=>({boardOpen:P.isActive()}),F.refresh=()=>{x()},()=>{P.dispose()}}const Xn=`dsh-pmboard/footer-action.css`,Q=`dsh-pmboard:open-board`,Zn={draft:`立项`,brainstorming:`需求分析`,design:`设计`,decomposing:`拆分`,implementing:`实施中`,accepting:`待验收`,done:`完成`},Qn=(0,e.createElement)(`svg`,{viewBox:`0 0 16 16`,width:`16`,height:`16`,fill:`none`,stroke:`currentColor`,"stroke-width":`1.4`,"stroke-linecap":`round`,"stroke-linejoin":`round`,"aria-hidden":`true`},(0,e.createElement)(`rect`,{x:`2`,y:`2`,width:`5`,height:`5`,rx:`1`}),(0,e.createElement)(`rect`,{x:`9`,y:`2`,width:`5`,height:`5`,rx:`1`}),(0,e.createElement)(`rect`,{x:`2`,y:`9`,width:`5`,height:`5`,rx:`1`}),(0,e.createElement)(`rect`,{x:`9`,y:`9`,width:`5`,height:`5`,rx:`1`}));function $n(){if(typeof document>`u`||document.querySelector(`style[data-plugin-css="${Xn}"]`))return;let e=document.createElement(`style`);e.dataset.pluginCss=Xn,e.textContent=`
.dsh-reqboard-foot {
...
`,document.head.appendChild(e)}function er(t){let{wide:n}=t,r=s,[i,a]=(0,e.useState)(!1),[o,c]=(0,e.useState)(null),[l,u]=(0,e.useState)(null),d=(0,e.useRef)(0),f=(0,e.useRef)(null),p=(0,e.useRef)(null),m=(0,e.useRef)(new Set),h=(0,e.useCallback)(async e=>{if(!(!e&&d.current>0&&Date.now()-d.current<15e3))try{let e=await(await fetch(`/dashboard/api/reqboard/requirements/summary`,{signal:AbortSignal.timeout(8e3)})).json().catch(()=>({}));e.success===!0?(m.current=dn(),c(e.data?.requirements??[]),u(null),d.current=Date.now()):u(e.error??`加载失败`)}catch(e){u(String(e))}},[]),g=(0,e.useCallback)(()=>{p.current!==null&&(window.clearTimeout(p.current),p.current=null),!i&&(f.current=window.setTimeout(()=>{a(!0),h(!1)},120))},[i,h]),_=(0,e.useCallback)(()=>{f.current!==null&&(window.clearTimeout(f.current),f.current=null),p.current=window.setTimeout(()=>a(!1),200)},[]),v=(0,e.useCallback)(e=>{let t=e.sourceSessionId;if(t===null||t.length===0||m.current.has(t)){window.dispatchEvent(new CustomEvent(Q,{detail:{open:!0}}));return}fn(un(),t).then(e=>{e===`archived`?window.alert(`该会话已归档（日志保留，侧栏不可见）`):e===`missing`?window.alert(`该会话不在当前列表（可能已删除）`):e===`unavailable`&&window.alert(`会话服务暂不可用，已打开项目看板`),e!==`opened`&&window.dispatchEvent(new CustomEvent(Q,{detail:{open:!0}}))})},[]),y=(0,e.createElement)(`button`,{type:`button`,className:n?`dsh-reqboard-foot wide`:`dsh-reqboard-foot rail`,title:`${r}（悬停查看进行中需求）`,"aria-label":r,onClick:()=>{window.dispatchEvent(new CustomEvent(Q,{detail:{open:!0}}))}},n?[(0,e.createElement)(`span`,{className:`dsh-reqboard-foot-icon`,key:`i`},Qn),(0,e.createElement)(`span`,{className:`dsh-reqboard-foot-label`,key:`l`},r)]:(0,e.createElement)(`span`,{className:`dsh-reqboard-foot-icon`,key:`i`},Qn));if(!i)return(0,e.createElement)(`div`,{className:`dsh-reqboard-foot-wrap${n?``:` rail`}`,onMouseEnter:g,onMouseLeave:_},y);let b=o===null?(0,e.createElement)(`div`,{className:`dsh-reqboard-empty`},l===null?`加载中…`:`加载失败：${l}`):o.length===0?(0,e.createElement)(`div`,{className:`dsh-reqboard-empty`},`暂无进行中的需求`):o.map(t=>{let n=Number.isFinite(t.percentage)?t.percentage:0,r=t.sourceSessionId,i=r!==null&&r.length>0,a=i&&m.current.has(r);return(0,e.createElement)(`button`,{key:t.id,type:`button`,className:`dsh-reqboard-item${a?` is-archived`:``}`,title:a?`${t.id}《${t.title}》— 来源会话 ${r} 已归档，无法跳转（点击打开看板）`:i?`${t.id}《${t.title}》— 点击跳转到会话 ${r}`:`${t.id}《${t.title}》— 人工建卡，无来源会话（点击打开看板）`,onClick:()=>v(t)},(0,e.createElement)(`div`,{className:`dsh-reqboard-item-top`,key:`top`},[(0,e.createElement)(`span`,{className:`dsh-reqboard-item-title`,key:`t`},`${t.id} ${t.title}`),(0,e.createElement)(`span`,{className:`dsh-reqboard-badge`,"data-status":t.status,key:`b`},Zn[t.status]??t.status)]),(0,e.createElement)(`div`,{className:`dsh-reqboard-item-meta`,key:`meta`},[t.windowCode===null?(0,e.createElement)(`span`,{key:`w`},`人工建卡`):(0,e.createElement)(`span`,{className:`dsh-reqboard-win${a?` is-archived`:``}`,key:`w`,title:a?`该会话已归档`:void 0},t.windowCode),(0,e.createElement)(`span`,{key:`s`},t.tasksTotal>0?`${t.tasksTotal} 任务${t.tasksActive>0?` · ${t.tasksActive} 进行中`:``}`:`未拆分`),(0,e.createElement)(`span`,{className:`dsh-reqboard-jump${a?` is-archived`:``}`,key:`j`},a?`已归档`:i?`跳转 →`:`看板 →`)]),(0,e.createElement)(`div`,{className:`dsh-reqboard-bar`,key:`bar`},[(0,e.createElement)(`span`,{className:`dsh-reqboard-bar-track`,key:`tr`},(0,e.createElement)(`i`,{className:`dsh-reqboard-bar-fill`,style:{width:`${n}%`}})),(0,e.createElement)(`span`,{className:`dsh-reqboard-bar-num`,key:`n`},`${t.tasksDone}/${t.tasksTotal}`)]))}),x=(0,e.createElement)(`div`,{className:`dsh-reqboard-drop`,onMouseEnter:g,onMouseLeave:_},[(0,e.createElement)(`div`,{className:`dsh-reqboard-drop-head`,key:`h`},[(0,e.createElement)(`span`,{key:`a`},`进行中需求`),(0,e.createElement)(`span`,{className:`n`,key:`b`},o===null?``:String(o.length))]),b,(0,e.createElement)(`div`,{className:`dsh-reqboard-drop-foot`,key:`f`},[(0,e.createElement)(`span`,{key:`l`},`点击条目跳转会话`),(0,e.createElement)(`button`,{key:`r`,type:`button`,onClick:()=>{h(!0)}},`刷新`)])]);return(0,e.createElement)(`div`,{className:`dsh-reqboard-foot-wrap${n?``:` rail`}`,onMouseEnter:g,onMouseLeave:_},[y,x])}const $=[{key:`draft`,label:`立项`},{key:`brainstorming`,label:`需求分析`},{key:`design`,label:`设计`},{key:`decomposing`,label:`拆分`},{key:`implementing`,label:`实施`},{key:`accepting`,label:`验收`},{key:`archived`,label:`归档`}],tr={draft:`立项`,brainstorming:`需求分析`,design:`设计`,decomposing:`拆分`,implementing:`实施中`,accepting:`待验收`,done:`完成`,archived:`归档`,canceled:`已取消`};function nr(e){if(typeof e==`string`&&e.length>0)return e;try{let e=window,t=(e.__dshPmSessions??e.__dshPmCtx?.sessions)?.list?.getSnapshot?.(),n=t?.current??t?.currentSessionId;if(typeof n==`string`&&n.length>0)return n}catch{}}function rr(e,t){return t<0?`pending`:e<t?`done`:e===t?`current`:`pending`}function ir(t){let n=t?.sessionId,[r,i]=(0,e.useState)(null),[a,o]=(0,e.useState)(!1),[s,c]=(0,e.useState)(null),[l,u]=(0,e.useState)(null),[d,f]=(0,e.useState)(!1),[p,m]=(0,e.useState)(``),h=(0,e.useRef)(null),g=(0,e.useRef)(void 0);(0,e.useEffect)(()=>{let e=!0,t=async()=>{let t=nr(n);if(t===void 0){e&&(g.current=void 0,i(null));return}t!==g.current&&(g.current=t,e&&i(null));try{let n=await fetch(`/dashboard/api/reqboard/session/${encodeURIComponent(t)}/progress`,{signal:AbortSignal.timeout(8e3)});if(!n.ok)return;let r=await n.json();if(!e)return;i(r.success===!0?r.data??null:null)}catch{}};t();let r=window.setInterval(()=>{t()},15e3);return()=>{e=!1,window.clearInterval(r)}},[n]),(0,e.useEffect)(()=>{if(!a)return;let e=e=>{let t=h.current;t!==null&&!t.contains(e.target)&&o(!1)};return document.addEventListener(`mousedown`,e),()=>document.removeEventListener(`mousedown`,e)},[a]);let _=r?.requirement?.id,v=r?.requirement?.updatedAt;(0,e.useEffect)(()=>{if(!a||_===void 0){u(null);return}let e=!0;return f(!0),m(``),Kt(_).then(t=>{e&&u(t)}).catch(t=>{e&&m(t.message)}).finally(()=>{e&&f(!1)}),()=>{e=!1}},[a,_,v]),(0,e.useEffect)(()=>{let e=e=>{let t=e.target.closest(`[data-action="open-doc"]`);if(t===null)return;e.preventDefault(),e.stopPropagation();let r=t.getAttribute(`data-path`);r!==null&&r.length!==0&&ln(window.__dshPmCtx,r,nr(n))};return document.addEventListener(`click`,e),()=>document.removeEventListener(`click`,e)},[n]);let y=r?.requirement;if(r===null||r.hasRequirement!==!0||y==null)return null;let b=r.progress?.done??0,x=r.progress?.total??0,S=y.status??`draft`,C=$.findIndex(e=>e.key===S),w=y.title??`（未命名需求）`,T=r.closed===!0,E=y.category??`feature`,D=L[E]??L.feature,O=new Set($.filter(e=>!D.stages.includes(e.key)).map(e=>e.key)),k=new Map;for(let e of r.nodes??[])typeof e.key==`string`&&typeof e.tokens?.total==`number`&&k.set(e.key,e.tokens.total);let A=[];$.forEach((t,n)=>{let r=rr(n,C),i=s===t.key,a=O.has(t.key);A.push((0,e.createElement)(`div`,{key:`n-${t.key}`,className:`dsh-pm-flow-node`,"data-state":a?`skipped`:r,"data-selected":i?`true`:void 0,title:a?`本分类（${E}）跳过「${t.label}」`:void 0,onClick:e=>{e.stopPropagation(),c(t.key),o(!0)}},[(0,e.createElement)(`span`,{key:`d`,className:`dsh-pm-flow-dot`},a?`—`:r===`done`?`✓`:r===`current`?`●`:n+1),(0,e.createElement)(`div`,{key:`m`,className:`dsh-pm-flow-meta`},[(0,e.createElement)(`span`,{key:`l`,className:`dsh-pm-flow-label`},t.label),...k.has(t.key)?[(0,e.createElement)(`span`,{key:`t`,className:`dsh-pm-flow-token`},B(k.get(t.key)))]:[]])])),n<$.length-1&&A.push((0,e.createElement)(`div`,{key:`l-${t.key}`,className:`dsh-pm-flow-link`,"data-state":n<C?`done`:`pending`}))});let j=(0,e.createElement)(`div`,{key:`flow`,className:`dsh-pm-cprog-inline${T?` is-closed`:``}`,title:`${y.id??``}《${w}》${tr[S]??S}${T?`（本会话最近完成）`:``} · 点击节点查看详情`,"aria-expanded":a},[(0,e.createElement)(`div`,{key:`f`,className:`dsh-pm-flow`},A),(0,e.createElement)(`span`,{key:`c`,className:`dsh-pm-cprog-inline-count`},x>0?`${b}/${x}`:tr[S]??S)]);if(!a)return(0,e.createElement)(`div`,{className:`dsh-pm-cprog`,ref:h},j);let M=(0,e.createElement)(`div`,{key:`panel`,className:`dsh-pm-cprog-detail-panel`},[(0,e.createElement)(`div`,{key:`h`,className:`dsh-pm-cprog-panel-head`},[(0,e.createElement)(`span`,{key:`t`,className:`dsh-pm-cprog-panel-title`},`${y.id??``} · ${w}`),(0,e.createElement)(`span`,{key:`s`,className:`dsh-pm-status-badge`,"data-status":S},tr[S]??S)]),T?(0,e.createElement)(`div`,{key:`closed`,className:`dsh-pm-cprog-panel-note`},`本会话已无进行中需求 —— 以上是最近关联的需求（已完成/已归档），可作为「这个会话做了什么」的回顾。`):null,(0,e.createElement)(`div`,{key:`ov`,className:`dsh-pm-cprog-sec`},[d&&l===null?(0,e.createElement)(`div`,{key:`ld`,className:`dsh-pm-cprog-empty`},`详情加载中…`):p.length>0&&l===null?(0,e.createElement)(`div`,{key:`er`,className:`dsh-pm-cprog-empty`},`详情暂不可用：`+p):l===null?(0,e.createElement)(`div`,{key:`ne`,className:`dsh-pm-cprog-empty`},`暂无详情`):(0,e.createElement)(`div`,{key:`ovr`,className:`dsh-pm-cprog-stage-detail`,dangerouslySetInnerHTML:{__html:zn(l,s??l.currentStage)}})]),(0,e.createElement)(`div`,{key:`ft`,className:`dsh-pm-cprog-foot`},[(0,e.createElement)(`button`,{key:`open`,type:`button`,className:`dsh-pm-btn sm`,onClick:()=>{window.dispatchEvent(new CustomEvent(Q,{detail:{open:!0}}))}},`打开项目看板`),(0,e.createElement)(`button`,{key:`open-req`,type:`button`,className:`dsh-pm-btn sm primary`,onClick:()=>{window.dispatchEvent(new CustomEvent(Q,{detail:{open:!0,req:y.id}}))}},`打开需求看板`),(0,e.createElement)(`button`,{key:`rf`,type:`button`,className:`dsh-pm-btn sm`,onClick:()=>{o(!1),c(null)}},`收起`)])]);return(0,e.createElement)(`div`,{className:`dsh-pm-cprog`,ref:h},[j,M])}const ar=`dsh-pmboard/styles.css`;function or(){if(typeof document>`u`||document.querySelector(`style[data-plugin-css="${ar}"]`))return;let e=document.createElement(`style`);e.dataset.pluginCss=ar,e.textContent=`
/* ================================================================== */
...
`,document.head.appendChild(e)}const sr=[`slots`,`sessions`,`workspaces`,`sidebarRight`];function cr(e){try{$n(),or(),window.__dshReqboardClient?.dispose(),window.__dshPmCtx=e,window.__dshPmSessions=e.sessions,window.__dshPmWorkspaces=e.workspaces;let t=Jn(),n=Yn(t),r=e=>{let n=e.detail;n?.open===!0?(t.openBoard(),n.req&&setTimeout(()=>{let e=document.querySelector(`[data-req="${n.req}"]`);e&&e.dispatchEvent(new MouseEvent(`click`,{bubbles:!0}))},200)):t.toggleBoard()};window.addEventListener(Q,r),window.__dshReqboardClient={dispose:()=>{window.removeEventListener(Q,r),n(),t.closeBoard(),delete window.__dshPmCtx,delete window.__dshPmSessions,delete window.__dshPmWorkspaces}};let i=e.slots;if(i){try{i.inject(`sidebar.footer.action`,()=>i.register({name:`sidebar.footer.action`,id:o,order:110,label:s},er))}catch(e){console.error(`[dsh-pmboard] Failed to register sidebar.footer.action:`,e)}try{i.inject(`conversation.session.header.utilities`,()=>i.register({name:`conversation.session.header.utilities`,id:`dsh-pmboard:progress`,order:5,inject:e=>({sessionId:e})},ir))}catch(e){console.error(`[dsh-pmboard] Failed to register conversation.session.header.utilities:`,e)}}else console.warn(`[dsh-pmboard] ctx.slots unavailable`)}catch(e){console.error(`[dsh-pmboard] client half failed to start:`,e)}}exports.apply=cr,exports.inject=sr,exports.name=`dsh-pmboard/client`;
