window.__ModuleLoader__.load({
		...
		Object.defineProperty(exports,Symbol.toStringTag,{value:`Module`});let e=require("react");const t=`dsh-panel-activate`;function n(){return document.querySelector(`[data-pane="conversation"], [class*="centerCol"], .dshDesktopConversationSurface`)??void 0}function r(e){return String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]??e)}function i(e){let{panelName:r,activeAttr:i,otherActiveAttrs:a,pollMs:o=3e4,pauseOnHidden:s=!1,dispatchTarget:c=`window`,listenTarget:l=`window`,buildContainer:u,onMount:d,onPoll:f,onOpen:p,onClose:m}=e,h=!1,g,_,v,y=!1,b=()=>{if(g!==void 0||y)return;let e=n();if(e===void 0)return;let t=u();e.appendChild(t),g=t,v=d(t)??void 0},x=new MutationObserver(()=>{b()});x.observe(document.body,{childList:!0,subtree:!0}),b();let S=()=>{if(!(h||y)){h=!0,b();for(let e of a)document.documentElement.removeAttribute(e);document.documentElement.setAttribute(i,``),(c===`document`?document:window).dispatchEvent(new CustomEvent(t,{detail:r})),D(),p?.()}},C=()=>{!h||y||(h=!1,document.documentElement.removeAttribute(i),O(),m?.())},w=()=>{h?C():S()},T=()=>h,E=()=>{h&&f()},D=()=>{O(),_=window.setInterval(E,o)},O=()=>{_!==void 0&&(clearInterval(_),_=void 0)},k=()=>{document.hidden?O():h&&D()};s&&document.addEventListener(`visibilitychange`,k);let A=t=>{if(!h)return;let n=t.target;if(n===null||g!==void 0&&(g===n||g.contains(n)))return;let r=`[data-`+e.prefix+`-entry]`;n.closest(r)===null&&C()};document.addEventListener(`click`,A,!0);let j=e=>{let t=e.detail;t!==void 0&&t!==r&&h&&C()},M=l===`document`?document:window;return M.addEventListener(t,j),{open:S,close:C,toggle:w,isActive:T,dispose:()=>{y||(y=!0,O(),s&&document.removeEventListener(`visibilitychange`,k),document.removeEventListener(`click`,A,!0),M.removeEventListener(t,j),x.disconnect(),v?.(),g?.remove(),g=void 0)}}}const a=`dsh-pmboard`,o=`项目看板`,s=[`data-dsh-atb-active`,`data-dsh-taskboard-active`,`data-dsh-ssh-active`,`data-dsh-hld-active`,`data-dsh-bbd-active`,`data-dsh-gen-active`,`data-dsh-exec-active`],c={draft:`立项`,reviewing:`评审`,decomposing:`拆分`,implementing:`实施`,accepting:`验收`,done:`完成`,archived:`归档`,canceled:`取消`},l={todo:`待办`,in_progress:`进行中`,integrating:`联调`,testing:`测试`,in_review:`验收`,done:`完成`,canceled:`取消`},u={doc:`文档`,ui:`UI`,analysis:`分析`,implement:`实施`,test:`测试`,review:`评审`,merge:`合并`},d={feature:`功能`,bug:`缺陷`,doc:`文档`,refactor:`重构`,spike:`调研`,chore:`杂项`},f=[`draft`,`reviewing`,`decomposing`,`implementing`,`accepting`,`done`];function p(e){let t=e.startsWith(`session-`)?e.slice(8):e;return`w-${(t.split(`-`)[0]??t).slice(0,8)}`}const m=e=>{let t=new Date(e),n=e=>String(e).padStart(2,`0`);return`${t.getMonth()+1}-${n(t.getDate())} ${n(t.getHours())}:${n(t.getMinutes())}`};function h(e,t){return t===0?`0/0`:`${e}/${t}`}function g(e){return e.requirements.filter(e=>e.status!==`archived`&&e.status!==`canceled`).map(t=>{let n=e.tasks.filter(e=>e.requirementId===t.id);return{req:t,tasks:n,doneCount:n.filter(e=>e.status===`done`).length,totalCount:n.length,readyIds:e.ready[t.id]??[],blocked:t.blocked||n.some(e=>e.blocked)}})}function _(e){let t=g(e),n=f.map(e=>{let n=t.filter(t=>t.req.status===e),r=n.map(e=>v(e)).join(``);return`
		    ...
		    </div>`).join(``)+`</div>`}function D(e,t){let n=e.executions.map(e=>`
		    ...
		    </div>`}function k(){return`<div class="dsh-pm-board"><div class="dsh-pm-empty">暂无数据 — 点击「+ 需求」创建第一个需求</div></div>`}function A(e){return`<div class="dsh-pm-board"><div class="dsh-pm-error">加载失败：${r(e)}</div></div>`}const j=8e3;var M=class extends Error{code;constructor(e,t){super(e),this.code=t}};async function N(e){let t=await e;if(!t.ok)throw new M(`HTTP `+t.status);let n=await t.json().catch(()=>({}));if(n.success!==!0)throw new M(n.error??`API 返回失败`,n.code);return n.data}const P=e=>N(fetch(e,{signal:AbortSignal.timeout(j)})),F=(e,t)=>N(fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t),signal:AbortSignal.timeout(j)})),I=()=>P(`/dashboard/api/reqboard/`),L=()=>P(`/dashboard/api/reqboard/triage`);function R(e){return F(`/dashboard/api/reqboard/req/create`,e)}function z(e){return F(`/dashboard/api/reqboard/req/move`,e)}function B(e){return F(`/dashboard/api/reqboard/comment`,e)}function V(e){return F(`/dashboard/api/reqboard/triage/confirm`,e)}function H(e){return F(`/dashboard/api/reqboard/triage/rebind`,e)}function U(e){return F(`/dashboard/api/reqboard/triage/reject`,e)}function W(e){let t=new EventSource(`/dashboard/api/reqboard/events`);return t.onmessage=t=>{try{let n=JSON.parse(t.data);e(n.revision,n.kind)}catch{}},()=>t.close()}function G(){let e=()=>window;return{getSessions:()=>{try{let t=e().__dshPmSessions??e().__dshPmCtx?.sessions;if(t&&typeof t.open==`function`&&t.list)return t}catch{}},getWorkspaces:()=>{try{let t=e().__dshPmWorkspaces??e().__dshPmCtx?.workspaces;if(t&&t.list)return t}catch{}}}}async function K(e,t){let n=e.getSessions();if(n===void 0)return`unavailable`;let r=e=>{try{return n.list.getSnapshot().byId[e]!==void 0}catch{return!1}};if(r(t))return(e.getWorkspaces()?.list.getSnapshot().archivedSessionIds??[]).includes(t)?`archived`:(n.open(t),`opened`);try{await n.refresh()}catch{}return r(t)?(e.getWorkspaces()?.list.getSnapshot().archivedSessionIds??[]).includes(t)?`archived`:(n.open(t),`opened`):`missing`}function q(){return{openBoard:()=>{},closeBoard:()=>{},toggleBoard:()=>{},getSnapshot:()=>({boardOpen:!1}),refresh:()=>{}}}function J(e){let t,n=[],r={kind:`board`},o,c,l=()=>{if(o!==void 0){if(t===void 0){o.innerHTML=k();return}switch(r.kind){case`board`:o.innerHTML=_(t);break;case`req`:{let e=t.requirements.find(e=>e.id===r.reqId);o.innerHTML=e?S(e,t.tasks):_(t),e||(r={kind:`board`});break}case`task`:{let e=t.tasks.find(e=>e.id===r.taskId),n=e?t.requirements.find(t=>t.id===e.requirementId):void 0;o.innerHTML=e?D(e,n):_(t),e||(r={kind:`board`});break}case`triage`:o.innerHTML=O(n,t)}}},u=async()=>{try{let[e,r]=await Promise.all([I(),L()]);t=e,n=r.pending,l()}catch(e){o!==void 0&&(o.innerHTML=A(String(e)))}},d=()=>{c?.(),c=W(()=>{u()})},f=e=>{let i=e.target.closest(`[data-action]`);if(i!==null&&t!==void 0)switch(i.dataset.action??``){case`refresh`:u();return;case`new-req`:{let e=window.prompt(`需求标题`);e&&e.trim()&&R({title:e.trim()}).then(()=>u()).catch(e=>window.alert(String(e)));return}case`open-req`:i.dataset.req&&(r={kind:`req`,reqId:i.dataset.req},l());return;case`open-task`:i.dataset.task&&(r={kind:`task`,taskId:i.dataset.task},l());return;case`back`:r={kind:`board`},l();return;case`back-req`:r={kind:`req`,reqId:i.dataset.req??``},l();return;case`move-req`:{let e=i.dataset.id??(r.kind===`req`?r.reqId:void 0),t=i.dataset.to;e&&t&&z({id:e,to:t,actor:`human`,reason:i.dataset.id?`看板泳道卡面操作`:`需求详情页操作`}).then(()=>u()).catch(e=>window.alert(String(e)));return}case`add-comment`:{let e=(o?.querySelector(`[data-role="comment-input"]`))?.value.trim();e&&i.dataset.target&&i.dataset.id&&B({target:i.dataset.target,id:i.dataset.id,body:e,actor:`human`}).then(()=>u()).catch(e=>window.alert(String(e)));return}case`jump-session`:{let e=i.dataset.sid;e&&K(G(),e).then(e=>{e===`archived`?window.alert(`该会话已归档（日志保留，侧栏不可见）`):e===`missing`?window.alert(`该会话不在当前列表（可能已删除）`):e===`unavailable`&&window.alert(`会话服务暂不可用`)});return}case`triage-confirm`:{let e=i.dataset.triage;if(!e)return;let t=n.find(t=>t.id===e);if(t?.suggestedAction===`bind_req`&&t.suggestedTargetId)V({triageId:e,action:`bind_req`,targetId:t.suggestedTargetId}).then(()=>u()).catch(e=>window.alert(String(e)));else{let t=i.closest(`.dsh-pm-triage`),n=t?.querySelector(`[data-role="triage-title"]`)?.value.trim(),r=t?.querySelector(`[data-role="triage-category"]`)?.value;V({triageId:e,action:`create_req`,...n?{title:n}:{},...r?{category:r}:{}}).then(()=>u()).catch(e=>window.alert(String(e)))}return}case`triage-rebind`:{let e=o?.querySelector(`.dsh-pm-rebind-host`);e&&(e.style.display=`flex`,e.dataset.triage=i.dataset.triage??``);return}case`triage-rebind-confirm`:{let e=o?.querySelector(`.dsh-pm-rebind-host`),t=e?.dataset.triage,n=e?.querySelector(`[data-role="rebind-select"]`);t&&n?.value&&H({triageId:t,targetId:n.value}).then(()=>u()).catch(e=>window.alert(String(e)));return}case`triage-reject`:{let e=i.dataset.triage;e&&U({triageId:e}).then(()=>u()).catch(e=>window.alert(String(e)));return}}},p=i({prefix:`dsh-pm`,panelName:a,activeAttr:`data-dsh-pm-active`,otherActiveAttrs:s,pollMs:2e4,pauseOnHidden:!0,buildContainer:()=>{let e=document.createElement(`div`);return e.dataset.dshPmView=``,e.className=`dsh-pm-view`,e},onMount:e=>(o=e,e.addEventListener(`click`,f),u(),d(),()=>{e.removeEventListener(`click`,f),c?.(),c=void 0,o=void 0}),onPoll:()=>{u()},onOpen:()=>{u()}}),m=e;return m.openBoard=p.open,m.closeBoard=p.close,m.toggleBoard=p.toggle,m.getSnapshot=()=>({boardOpen:p.isActive()}),m.refresh=()=>{u()},()=>{p.dispose()}}const Y=`dsh-pmboard/footer-action.css`,X=`dsh-pmboard:open-board`,Z=(0,e.createElement)(`svg`,{viewBox:`0 0 16 16`,width:`16`,height:`16`,fill:`none`,stroke:`currentColor`,"stroke-width":`1.4`,"stroke-linecap":`round`,"stroke-linejoin":`round`,"aria-hidden":`true`},(0,e.createElement)(`rect`,{x:`2`,y:`2`,width:`5`,height:`5`,rx:`1`}),(0,e.createElement)(`rect`,{x:`9`,y:`2`,width:`5`,height:`5`,rx:`1`}),(0,e.createElement)(`rect`,{x:`2`,y:`9`,width:`5`,height:`5`,rx:`1`}),(0,e.createElement)(`rect`,{x:`9`,y:`9`,width:`5`,height:`5`,rx:`1`}));function Q(){if(typeof document>`u`||document.querySelector(`style[data-plugin-css="${Y}"]`))return;let e=document.createElement(`style`);e.dataset.pluginCss=Y,e.textContent=`
		.dsh-reqboard-foot {
		...
		`,document.head.appendChild(e)}function ee(t){let{wide:n}=t,r=o;return(0,e.createElement)(`button`,{type:`button`,className:n?`dsh-reqboard-foot wide`:`dsh-reqboard-foot rail`,title:r,"aria-label":r,onClick:()=>{window.dispatchEvent(new CustomEvent(X,{detail:{open:!0}}))}},n?[(0,e.createElement)(`span`,{className:`dsh-reqboard-foot-icon`,key:`i`},Z),(0,e.createElement)(`span`,{className:`dsh-reqboard-foot-label`,key:`l`},r)]:(0,e.createElement)(`span`,{className:`dsh-reqboard-foot-icon`,key:`i`},Z))}const $=`dsh-pmboard/styles.css`;function te(){if(typeof document>`u`||document.querySelector(`style[data-plugin-css="${$}"]`))return;let e=document.createElement(`style`);e.dataset.pluginCss=$,e.textContent=`
		...
		`,document.head.appendChild(e)}const ne=[`slots`,`sessions`,`workspaces`];function re(e){try{Q(),te(),window.__dshReqboardClient?.dispose(),window.__dshPmCtx=e,window.__dshPmSessions=e.sessions,window.__dshPmWorkspaces=e.workspaces;let t=q(),n=J(t),r=e=>{e.detail?.open===!0?t.getSnapshot().boardOpen?t.closeBoard():t.openBoard():t.toggleBoard()};window.addEventListener(X,r),window.__dshReqboardClient={dispose:()=>{window.removeEventListener(X,r),n(),t.closeBoard(),delete window.__dshPmCtx,delete window.__dshPmSessions,delete window.__dshPmWorkspaces}};let i=e.slots;i?i.inject(`sidebar.footer.action`,()=>i.register({name:`sidebar.footer.action`,id:a,order:110,label:o},ee)):console.warn(`[dsh-pmboard] ctx.slots unavailable`)}catch(e){console.error(`[dsh-pmboard] client half failed to start:`,e)}}exports.apply=re,exports.inject=ne,exports.name=`dsh-pmboard/client`;
