...
import { defineConfirmArtifactTool } from '../src/host/agent-tools.js'
import { recordRecentUserMsg, CONFIRM_EVIDENCE_WINDOW_MS, type RecentUserMsg } from '../src/host/capture-hook.js'
