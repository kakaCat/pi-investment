...
function renderReviewContent(task: TaskRecord): string {
  return '<div class="dsh-pm-detail-section"><div class="dsh-pm-empty">评审节点内容待实现（P1）</div></div>'
}

function renderMergeContent(task: TaskRecord): string {
  return '<div class="dsh-pm-detail-section"><div class="dsh-pm-empty">合并节点内容待实现（P1）</div></div>'
}

function renderDocContent(task: TaskRecord): string {
  return '<div class="dsh-pm-detail-section"><div class="dsh-pm-empty">文档节点内容待实现（P2）</div></div>'
}

function renderUIContent(task: TaskRecord): string {
  return '<div class="dsh-pm-detail-section"><div class="dsh-pm-empty">UI节点内容待实现（P2）</div></div>'
}

function renderAnalysisContent(task: TaskRecord): string {
  return '<div class="dsh-pm-detail-section"><div class="dsh-pm-empty">分析节点内容待实现（P2）</div></div>'
}
