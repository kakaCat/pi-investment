 ...
 * 持仓列表工具类
 */
export class PositionListTool extends BaseTool<PositionListParams, PositionListResult> {
   ...
   * Phase 3: 包装返回数据
   */
  protected wrap(result: PositionListResult, _context: ToolContext): ToolResponse<PositionListResult> {
    // 检查是否为数组
