 ...
 * 账户信息工具类
 */
class AccountInfoTool extends BaseTool<AccountInfoParams, AccountInfoResult> {
   ...
   * Phase 2: 执行任务
   */
  protected async execute(args: AccountInfoParams, context: ToolContext): Promise<AccountInfoResult> {
   ...
   * Phase 3: 包装返回数据
   */
  protected wrap(result: AccountInfoResult, context: ToolContext): ToolResponse<AccountInfoResult> {
    // 检查必需字段
