...
| **文档 wiki** | 每周 | `python3 agent-dh/scripts/wiki_probe.py` | 退出码 1 = wiki 页有死链/孤儿/缺 front-matter | 死链、孤儿页、缺字段 |
...
- wiki 探针（2026-09-13 新增，服务于归档 wiki 的页面图完整性）；
