...
CONFIG = {
    ...
    'risk_management': {
        # 分级止盈
        'take_profit_levels': [
            {'threshold': 0.15, 'position': 0.4},  # 15%收益：减仓到40%
            {'threshold': 0.12, 'position': 0.6},  # 12%收益：减仓到60%
            {'threshold': 0.10, 'position': 0.8},  # 10%收益：减仓到80%
        ],
        # 峰值回撤止损
        'drawdown_stops': [
            {'threshold': -0.15, 'position': 0.3},  # 回撤15%：减仓到30%
            {'threshold': -0.10, 'position': 0.5},  # 回撤10%：减仓到50%
        ],
    },
