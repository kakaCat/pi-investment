...
class StrategyCircuitBreaker:
    ...
    def __init__(
        ...
        # repo 可选参数兜底：未注入时使用具体 ORM 实现，避免裸构造后
        # self.repo=None → get_state/record_trade 时 AttributeError
