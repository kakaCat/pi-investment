...
CONFIG = {
    ...
    'risk_management': {
        # 更激进分级止盈（四阶梯）
        'take_profit_levels': [
            {'threshold': 0.12, 'position': 0.3},  # 12%收益：减仓到30%
            {'threshold': 0.10, 'position': 0.5},  # 10%收益：减仓到50%
            {'threshold': 0.08, 'position': 0.7},  # 8%收益：减仓到70%
            {'threshold': 0.06, 'position': 0.85}, # 6%收益：减仓到85%
        ],
        # 更紧峰值回撤止损（三阶梯）
        'drawdown_stops': [
            {'threshold': -0.12, 'position': 0.3},  # 回撤12%：减仓到30%
            {'threshold': -0.08, 'position': 0.5},  # 回撤8%：减仓到50%
            {'threshold': -0.06, 'position': 0.7},  # 回撤6%：减仓到70%
        ],
    },
