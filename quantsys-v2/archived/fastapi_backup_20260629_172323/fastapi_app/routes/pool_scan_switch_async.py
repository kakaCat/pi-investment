...
2. GET /api/pools/scan-status - 查看所有股票池的扫描状态 - FastAPI 异步版本
自动生成，需要根据实际业务逻辑调整
"""
...
router = APIRouter(prefix="/api/pool_scan_switch", tags=["Pool Scan Switch"])
...
# TODO: 添加更多端点
# 参考 Flask 路由文件: adapters/inbound/api/routes/pool_scan_switch.py
