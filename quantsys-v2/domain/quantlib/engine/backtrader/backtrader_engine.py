...
class BacktraderEngine:
    ...
    def backtest_single(
        ...
        from domain.quantlib.engine.backtrader.strategy_adapter import IndicatorStrategyAdapter
    ...
    def backtest_with_strategy_obj(
        ...
        """
        from domain.quantlib.engine.backtrader.data_feed import PandasDataFeed
        from domain.quantlib.engine.backtrader.strategy_adapter import SignalStrategyAdapter
