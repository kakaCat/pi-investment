...
const ROUTE_RULES: RouteRule[] = [
  ...
  {
    skillName: "portfolio-entry",
    priority: 65,
    minScore: 1,
    positive: [/记录交易/, /录入交易/, /交易记录/, /我卖了/, /卖出/, /买入/, /成交/, /手续费/, /清仓/, /录入持仓/, /添加持仓/, /更新持仓/, /帮我记录持仓/, /建仓/, /加仓/, /持有.*均价/, /成本价/],
    negative: [/查看持仓/, /持仓复盘/, /大盘/, /市场怎么样/],
  },
  {
    skillName: "quant-strategy",
    priority: 58,
    minScore: 1,
    positive: [/量化/, /策略/, /因子/, /轮动/, /回测/, /股票池/],
    negative: [/持仓/, /复盘/, /k线/, /止损/, /大盘怎么样/],
  },
  {
    skillName: "evolution",
    priority: 55,
